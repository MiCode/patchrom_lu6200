...
.field static final TOP_CLASS:I = 0x0

.field static final TOP_PACKAGE:I = 0x1
...
# instance fields
.field arrayListHome:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field arrayListHome3D:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field mBlockingQuicclip:Z

.field mBlockingScreencapture:Z
...
.field private final mCancel_QuickClipChordLongPress:Ljava/lang/Runnable;
...
.field mPouchEnablesAccelerometer:Z

.field mPouchRotation:I
...
.field private final manager:Landroid/app/IActivityManager;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "com.android.settings.lgesetting.wireless.DataEnabledSettingBootableSKT"
    ...
    const-string v1, "com.android.settings.lgesetting.wireless.DataNetworkModePayPopupKT"
...
.method public constructor <init>()V
    ...
    .line 371
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerKeyScreenOn:Z

    .line 372
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPendingPowerKeyUpCanceled:Z
    ...
    .line 434
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockingScreencapture:Z

    .line 435
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockingQuicclip:Z

    .line 439
    const/4 v0, 0x2

    new-array v0, v0, [Lcom/android/internal/policy/impl/MiuiGlobalActions;

    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mGlobalActions:[Lcom/android/internal/policy/impl/MiuiGlobalActions;

    .line 440
    iput v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIdxGlobalDlg:I
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCancel_QuickClipChordLongPress:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->manager:Landroid/app/IActivityManager;

    .line 1774
    iput-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->arrayListHome:Ljava/util/ArrayList;

    .line 1775
    iput-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->arrayListHome3D:Ljava/util/ArrayList;
...
.method private containsListHome()Z
    .locals 5
    ...
    invoke-direct {p0, v3}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getTopAppName(I)Ljava/lang/String;

    move-result-object v2

    .line 1781
    .local v2, name:Ljava/lang/String;
    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->arrayListHome:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->arrayListHome:Ljava/util/ArrayList;
    ...
    .local v1, i:I
    :goto_0
    sget-object v3, Lcom/android/internal/policy/impl/PhoneWindowManager;->HOME_KEY_EXCEPTION_LIST:[Ljava/lang/String;
...
.method private getTopAppName(I)Ljava/lang/String;
    .locals 8
    .parameter "mode"
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->manager:Landroid/app/IActivityManager;
...
.method private interceptQuickClipChord()V
    ...
    .line 574
    iput-boolean v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockingQuicclip:Z

    .line 575
    const-string v4, "WindowManager"

    const-string v5, "Blocking mBlockingQuicclip"
    ...
    :cond_0
    :goto_1
    invoke-direct {p0, v6}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getTopAppName(I)Ljava/lang/String;

    move-result-object v4

    const-string v5, "com.lge.phonetestmode"
    ...
    .line 586
    iget-boolean v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockingQuicclip:Z
    ...
    iget-object v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mQuickClipChordLongPress:Ljava/lang/Runnable;
    ...
    .restart local v1       #extend:I
    :cond_4
    const/4 v4, 0x0

    iput-boolean v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockingQuicclip:Z
    ...
    iget-object v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCancel_QuickClipChordLongPress:Ljava/lang/Runnable;
...
.method private interceptScreenshotChord()V
    ...
    const-string v4, " mVolumeUpKeyTriggered="
...
.method private takeScreenshot()V
    ...
    invoke-interface {v5, v7}, Lcom/lge/cappuccino/IMdm;->getAllowScreenCapture(Landroid/content/ComponentName;)Z
    ...
    const-string v7, "LGMDM Block ScreenCapture"
    ...
    invoke-interface {v5, v7}, Lcom/lge/cappuccino/IMdm;->sendToastMessageId(I)V
    ...
    const-string v7, "Blocking ScreenCapture"
    ...
    invoke-virtual {v5, v4, v2, v7}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
...
.method public detectSafeMode()Z
    ...
    .line 4614
    const-string v8, "ro.lge.rst.flag"
    ...
    .line 4615
    .local v3, reset_cmd_buf:Ljava/lang/String;
    const-string v8, "ro.lge.usbcable.info"
    ...
    .line 4619
    .local v4, reset_cmd_buf2:Ljava/lang/String;
    const-string v8, "sub_rst_mode"
    ...
    const-string v9, "Vibration is skipped becasue of Silent reset or SystemServer reset"
    ...
    .line 4611
    .end local v3           #reset_cmd_buf:Ljava/lang/String;
    .end local v4           #reset_cmd_buf2:Ljava/lang/String;
    :cond_2
    const/4 v8, 0x0
    ...
    .line 4624
    .restart local v3       #reset_cmd_buf:Ljava/lang/String;
    .restart local v4       #reset_cmd_buf2:Ljava/lang/String;
    :cond_3
    const/4 v9, 0x0
    ...
    .restart local v0       #dpadState:I
    .restart local v2       #menuState:I
    .restart local v3       #reset_cmd_buf:Ljava/lang/String;
    .restart local v4       #reset_cmd_buf2:Ljava/lang/String;
    .restart local v5       #sState:I
    .restart local v6       #trackballState:I
    .restart local v7       #volumeDownState:I
    :cond_4
    const/16 v8, 0x2710
...
.method public finishAnimationLw()I
    ...
    .line 3024
    iget-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mForceStatusBar:Z
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStatusBarManager:Landroid/app/StatusBarManager;
    ...
    .line 3098
    iget-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDismissKeyguard:Z
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;Landroid/os/LocalPowerManager;)V
    ...
    .line 1038
    const/high16 v6, 0x207

    invoke-direct {p0, v6}, Lcom/android/internal/policy/impl/PhoneWindowManager;->readRotation(I)I

    move-result v6

    iput v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPouchRotation:I
    ...
    iput-boolean v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPouchEnablesAccelerometer:Z
    ...
    const-string v6, "android.intent.action.WIFI_DISPLAY_VIDEO"
    ...
    .line 1075
    iget-object v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->cpcErrReceiver:Landroid/content/BroadcastReceiver;

    new-instance v7, Landroid/content/IntentFilter;

    const-string v8, "android.intent.action.EXCESS_SPC_FAIL_EVENT"
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    const-string v43, "interceptKeyTi keyCode="
    ...
    .line 1839
    sget-boolean v41, Lcom/android/internal/policy/impl/PhoneWindowManager;->SPC_ERR_FREEZE:Z
    ...
    cmp-long v41, v26, v35

    if-gez v41, :cond_3

    .line 1852
    sub-long v41, v35, v26
    ...
    const-string v42, "reset mVolumeDownKeyConsumedByScreenshotChord / mVolumeDownKeyTriggered"
    ...
    .line 1887
    :cond_8
    sget-boolean v41, Lcom/lge/config/ConfigBuildFlags;->CAPP_QUICKCLIP_KEY:Z
    ...
    const-string v42, "gsm.lge.ota_is_running"
    ...
    const-string v42, "OTA home key ignore!"
    ...
    invoke-interface/range {v41 .. v41}, Lcom/lge/cappuccino/IMdm;->getEnforcePasswordChange()Z
    ...
    const-string v42, "LGMDM:HOME is locked!!"
    ...
    const-string v42, "vzw_ecm_exit"

    invoke-static/range {v41 .. v42}, Lcom/android/internal/telephony/lgeAutoProfiling;->isSupportFeature(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-interface/range {v28 .. v28}, Lcom/android/internal/telephony/ITelephony;->isEcmDialog()Z
    ...
    const-string v41, "android.intent.action.EMERGENCY_CALLBACK_MODE_EXIT_KEY"
    ...
    .line 1951
    .local v18, intent_ECMhomekey:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 1952
    const-string v41, "ECM"

    const-string v42, "1.ACTION_EMERGENCY_CALLBACK_MODE_EXIT_KEY"
    ...
    .line 1957
    .end local v18           #intent_ECMhomekey:Landroid/content/Intent;
    :cond_10
    const/16 v41, 0x0

    const-string v42, "ota_for_vzw"
    ...
    const-string v43, "SETUP_WIZARD_SKIP : "

    invoke-virtual/range {v42 .. v43}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v42

    invoke-interface/range {v28 .. v28}, Lcom/android/internal/telephony/ITelephony;->isSetupWizardSkip()Z
    ...
    .line 1959
    invoke-interface/range {v28 .. v28}, Lcom/android/internal/telephony/ITelephony;->isOtaCallProceeding()Z
    ...
    const-string v42, "OTA call committed... Home key is blocked"
    ...
    const-string v42, "Unable to find ITelephony interface"
    ...
    const-string v41, "com.lge.setup_wizard.AUTORUNON"
    ...
    .line 1984
    .local v19, intent_autorun:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    const-string v41, "com.android.LGSetupWizard"

    const-string v42, "com.android.LGSetupWizard.SetupStart"
    ...
    .line 1989
    .local v25, name:Landroid/content/ComponentName;
    move-object/from16 v0, p0
    ...
    const-string v43, "LGSetupWizardDisable"
    ...
    const-string v41, "android.intent.category.HOME"
    ...
    .line 2000
    const-string v31, "com.android.LGSetupWizard"

    .line 2002
    .local v31, setupWizard:Ljava/lang/String;
    :try_start_1
    move-object/from16 v0, v29
    ...
    const-string v42, "haksung_temp LGSetupWizard COMPONENT_ENABLED_STATE_DISABLED"
    ...
    .end local v19           #intent_autorun:Landroid/content/Intent;
    .end local v25           #name:Landroid/content/ComponentName;
    .end local v29           #pm:Landroid/content/pm/PackageManager;
    .end local v31           #setupWizard:Ljava/lang/String;
    ...
    const-string v42, "bypass HOME to phone apk: there\'s a ringing incoming call."
    ...
    .restart local v19       #intent_autorun:Landroid/content/Intent;
    .restart local v25       #name:Landroid/content/ComponentName;
    .restart local v29       #pm:Landroid/content/pm/PackageManager;
    .restart local v31       #setupWizard:Ljava/lang/String;
    ...
    const-string v42, "cannot disable setup wizard"
    ...
    .line 2069
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->containsListHome()Z
    ...
    .line 2079
    .restart local v28       #phoneServ:Lcom/android/internal/telephony/ITelephony;
    if-eqz v28, :cond_1f
    ...
    .line 2084
    .restart local v18       #intent_ECMhomekey:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    const-string v42, "2.ACTION_EMERGENCY_CALLBACK_MODE_EXIT_KEY"
    ...
    :cond_24
    sget-boolean v41, Lcom/lge/config/ConfigBuildFlags;->CAPP_KEY_EXCEPTION:Z
    ...
    .line 2124
    .local v37, topWindowAttrs:Landroid/view/WindowManager$LayoutParams;
    :goto_a
    if-eqz v37, :cond_27
    ...
    .line 2121
    .end local v12           #extend:I
    .end local v37           #topWindowAttrs:Landroid/view/WindowManager$LayoutParams;
    :cond_25
    const/16 v37, 0x0
    ...
    .line 2129
    .restart local v12       #extend:I
    .restart local v37       #topWindowAttrs:Landroid/view/WindowManager$LayoutParams;
    :cond_26
    ...
    .line 2180
    sget-boolean v41, Lcom/lge/config/ConfigBuildFlags;->CAPP_MENU_LONG:Z
    ...
    .line 2225
    .local v17, intent_ECMbackkey:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    const-string v42, "3.ACTION_EMERGENCY_CALLBACK_MODE_EXIT_KEY"
    ...
    .line 2230
    .end local v17           #intent_ECMbackkey:Landroid/content/Intent;
    :cond_35
    const-string v41, "WindowManager"
    ...
    .end local v11           #ex:Landroid/os/RemoteException;
    :cond_36
    sget-boolean v41, Lcom/lge/config/ConfigBuildFlags;->CAPP_REAL3D:Z
    ...
    const-string v42, "*** real3d auto conversion is enable, ignore 3d key ***"
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    const-string v23, "KEY_TESTMODE_UNLOCK : Clear pattern lock"
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->clearLockPattern()V
    ...
    :goto_2
    sget-boolean v22, Lcom/android/internal/policy/impl/PhoneWindowManager;->SPC_ERR_FREEZE:Z
    ...
    .line 3722
    sget-boolean v22, Lcom/lge/config/ConfigBuildFlags;->CAPP_QUICKCLIP_KEY:Z
    ...
    const-string v23, "BeforeQueueing ==> KEYCODE_VOLUME_DOWN"
    ...
    const-string v23, "BeforeQueueing ==> KEYCODE_VOLUME_UP"
    ...
    const-string v23, "Wakeup action by volume key : ITelephony threw RemoteException"
    ...
    const-string v23, "telephonyService.endCall()"
    ...
    const-string v23, "KEYCODE_ENDCALL : send action com.lge.vt.action.NOTIFICATION_CALL_END"
    ...
    const-string v22, "com.lge.vt.action.NOTIFICATION_CALL_END"
    ...
    .line 3872
    .local v11, hdvtActionIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 3877
    .end local v11           #hdvtActionIntent:Landroid/content/Intent;
    :cond_1f
    if-eqz p3, :cond_20
    ...
    invoke-static/range {v22 .. v23}, Landroid/media/AudioSystem;->isStreamActive(II)Z
    ...
    const-string v23, "interceptKeyBeforeQueueing: Stop notification"
    ...
    const-string v22, "android.media.STOP_NOTIFICATION"
    ...
    :cond_24
    sget-boolean v22, Lcom/lge/config/ConfigBuildFlags;->CAPP_KEY_EXCEPTION:Z
    ...
    const-string v23, "EXTEND_BYPASS_POWER_KEY"
    ...
    const-string v23, "EXTEND_IGNORE_POWER_KEY"
    ...
    const-string v23, "EXTEND_DONOT_LCDOFF_KEY"
    ...
    .line 3952
    invoke-interface {v5}, Landroid/media/IAudioService;->getRingerMode()I

    move-result v22

    if-eqz v22, :cond_2d

    invoke-interface/range {v21 .. v21}, Lcom/android/internal/telephony/ITelephony;->isReservedCall()Z
    ...
    const-string v23, "send action com.lge.vt.action.POWERKEY_DOWN"
    ...
    const-string v22, "com.lge.vt.action.POWERKEY_DOWN"
    ...
    .line 3990
    .restart local v11       #hdvtActionIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v10}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptPowerKeyDown(Z)V
    ...
    invoke-interface {v5}, Landroid/media/IAudioService;->isWiredHeadsetConnected()Z
    ...
    invoke-interface {v5}, Landroid/media/IAudioService;->isBluetoothAVConnected()Z
    ...
    const-string v23, "power key: screenTurnedOff() called"
    ...
    const-string v24, "mPowerKeyScreenOn="
    ...
    new-instance v23, Lcom/android/internal/policy/impl/PhoneWindowManager$PassHeadsetKey;
    ...
    const-string v23, "interceptKeyBeforeQueueing:VT CALL_END key-down"
    ...
    const-string v23, "interceptKeyBeforeQueueing:VT CALL_RECEIVE key-down"
    ...
    const-string v22, "INCOMING_CALL_RESULT"
    ...
    .line 4140
    .restart local v13       #intent:Landroid/content/Intent;
    const-string v22, "SEND_INCOMING_CALL_MODE"

    const-string v23, "INCOMING_CALL_ACCEPT"
...
.method needSensorRunningLp()Z
    ...
    :cond_4
    iget-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPouchEnablesAccelerometer:Z
...
.method public performHapticFeedbackLw(Landroid/view/WindowManagerPolicy$WindowState;IZ)Z
    ...
    invoke-virtual {v4, v5, v6, v7}, Landroid/os/Vibrator;->vibrate(JI)V
    ...
    invoke-virtual {v2, v1, v4, v7}, Landroid/os/Vibrator;->vibrate([JII)V
...
.method public rotationForOrientationLw(II)I
    ...
    .line 4399
    .local v2, shouldConsiderKeyguardOrientation:Z
    ...
    iget v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPouchRotation:I

    if-ltz v5, :cond_e

    .line 4441
    iget v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPouchRotation:I
    ...
    .end local v2           #shouldConsiderKeyguardOrientation:Z
    :catchall_0
    move-exception v3
    ...
    .restart local v2       #shouldConsiderKeyguardOrientation:Z
    :cond_e
    :try_start_1
...
.method showGlobalActionsDialog()V
    ...
    new-instance v6, Lcom/android/internal/policy/impl/MiuiGlobalActions;

    iget-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mContext:Landroid/content/Context;

    invoke-direct {v6, v7}, Lcom/android/internal/policy/impl/MiuiGlobalActions;-><init>(Landroid/content/Context;)V
    ...
    .line 886
    .local v1, fuel_level_cmd:Ljava/io/BufferedWriter;
    :try_start_0
    new-instance v2, Ljava/io/BufferedWriter;

    new-instance v4, Ljava/io/FileWriter;

    const-string v5, "/sys/module/lge_emmc_direct_access/parameters/fuel_level"
    ...
    .line 887
    .end local v1           #fuel_level_cmd:Ljava/io/BufferedWriter;
    .local v2, fuel_level_cmd:Ljava/io/BufferedWriter;
    :try_start_1
    const-string v4, "0"
    ...
    .line 900
    .end local v2           #fuel_level_cmd:Ljava/io/BufferedWriter;
    .restart local v1       #fuel_level_cmd:Ljava/io/BufferedWriter;
    :cond_4
    :goto_1
    iget-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mGlobalActions:[Lcom/android/internal/policy/impl/MiuiGlobalActions;
    ...
    .line 894
    .end local v1           #fuel_level_cmd:Ljava/io/BufferedWriter;
    .restart local v2       #fuel_level_cmd:Ljava/io/BufferedWriter;
    :catch_0
    move-exception v0
    ...
    const-string v6, "Write fuel_level_cmd fail"
    ...
    const-string v7, "Write fuel_level_cmd fail"
