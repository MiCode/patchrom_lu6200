...
.field private static final LOCK_STATUS_RELEASED:I = 0x0
...
.field private mEmergencyCallButtonforPukBlock:Landroid/widget/Button;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sOperator:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sModel:Ljava/lang/String;
...
.method public constructor <init>(Landroid/view/View;Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;Lcom/android/internal/widget/LockPatternUtils;Lcom/android/internal/policy/impl/KeyguardScreenCallback;ZI)V
    ...
    .line 203
    :cond_0
    sget-object v5, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sOperator:Ljava/lang/String;
    ...
    sget-object v5, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sModel:Ljava/lang/String;

    const-string v6, "L-01D"
    ...
    const-string v6, "/system/fonts/Roboto-Regular.ttf"
    ...
    iput-object v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mEmergencyCallButtonforPukBlock:Landroid/widget/Button;
    ...
    iput-object v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mDocTouchIcon:Landroid/widget/ImageView;
    ...
    iput-object v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mUnlockFrame:Landroid/widget/FrameLayout;
    ...
    .line 244
    iget-object v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mEmergencyCallButtonforPukBlock:Landroid/widget/Button;
    ...
    const-string v6, "mEmergencyCallButton != null"
    ...
    :cond_8
    invoke-virtual {p0, p6}, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->notifyLockScreenStatus(I)V
...
.method private updateCarrierStateWithSimStatus(Lcom/android/internal/telephony/IccCard$State;)V
    ...
    .line 550
    sget-object v2, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sOperator:Ljava/lang/String;
    ...
    sget-object v2, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sModel:Ljava/lang/String;

    const-string v3, "L-01D"
    ...
    .line 585
    iget-object v2, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mDocTouchIcon:Landroid/widget/ImageView;
    ...
    .line 587
    :cond_3
    iget-object v2, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mUnlockFrame:Landroid/widget/FrameLayout;
...
.method notifyLockScreenStatus(I)V
    .locals 4
    .parameter "status"
    ...
    .line 849
    const-string v0, "persist.service.keyguard.status"

    .line 850
    .local v0, PROPERTY_LOCKSCREEN:Ljava/lang/String;
    if-nez p1, :cond_0
...
.method public onCleanUp()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->notifyLockScreenStatus(I)V
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 819
    :cond_0
    sget-object v0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sOperator:Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sModel:Ljava/lang/String;
    ...
    .line 820
    iget-object v0, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mEmergencyCallButtonforPukBlock:Landroid/widget/Button;
...
.method protected updateEmergencyCallButtonState(I)V
    ...
    invoke-virtual {v4, v5, p1, v1}, Lcom/android/internal/widget/LockPatternUtils;->updateEmergencyCallButtonState(Landroid/widget/Button;IZ)V

    .line 743
    .end local v0           #enabledBecauseSimLocked:Z
    .end local v1           #shown:Z
    :cond_1
    sget-object v4, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sOperator:Ljava/lang/String;
    ...
    sget-object v4, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->sModel:Ljava/lang/String;

    const-string v5, "L-01D"
    ...
    .line 745
    iget-object v4, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mEmergencyCallButtonforPukBlock:Landroid/widget/Button;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mEmergencyCallButtonforPukBlock:Landroid/widget/Button;
