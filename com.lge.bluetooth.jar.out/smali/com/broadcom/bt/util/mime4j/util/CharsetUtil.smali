.class public Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$1;,
        Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;
    }
.end annotation
...
.field private static JAVA_CHARSETS:[Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset; = null
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 811
    const-class v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;

    invoke-static {v5}, Lcom/broadcom/bt/util/mime4j/LogFactory;->getLog(Ljava/lang/Class;)Lcom/broadcom/bt/util/mime4j/Log;

    move-result-object v5

    sput-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->log:Lcom/broadcom/bt/util/mime4j/Log;

    .line 830
    const/16 v5, 0x93

    new-array v5, v5, [Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;

    const/4 v6, 0x0

    new-instance v7, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;
    ...
    invoke-direct {v7, v8, v9, v10, v11}, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$1;)V
    ...
    sput-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->JAVA_CHARSETS:[Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;

    .line 1023
    const/4 v5, 0x0

    sput-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->decodingSupported:Ljava/util/TreeSet;

    .line 1029
    const/4 v5, 0x0

    sput-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->encodingSupported:Ljava/util/TreeSet;

    .line 1035
    const/4 v5, 0x0

    sput-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->charsetMap:Ljava/util/HashMap;
    ...
    .local v2, i:I
    :goto_0
    sget-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->JAVA_CHARSETS:[Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;
    ...
    #getter for: Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->canonical:Ljava/lang/String;
    invoke-static {v5}, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->access$100(Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;)Ljava/lang/String;
    ...
    sget-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->decodingSupported:Ljava/util/TreeSet;

    sget-object v6, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->JAVA_CHARSETS:[Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;

    aget-object v6, v6, v2

    #getter for: Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->canonical:Ljava/lang/String;
    invoke-static {v6}, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->access$100(Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;)Ljava/lang/String;
    ...
    .line 1050
    sget-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->encodingSupported:Ljava/util/TreeSet;
    ...
    .line 1059
    .local v0, c:Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;
    sget-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->charsetMap:Ljava/util/HashMap;

    #getter for: Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->canonical:Ljava/lang/String;
    invoke-static {v0}, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->access$100(Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;)Ljava/lang/String;
    ...
    .line 1060
    #getter for: Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->mime:Ljava/lang/String;
    invoke-static {v0}, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->access$200(Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;)Ljava/lang/String;
    ...
    .line 1063
    :cond_1
    #getter for: Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->aliases:[Ljava/lang/String;
    invoke-static {v0}, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;->access$300(Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;)[Ljava/lang/String;
    ...
    .line 1070
    .end local v0           #c:Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;
    :cond_3
    sget-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->log:Lcom/broadcom/bt/util/mime4j/Log;

    invoke-virtual {v5}, Lcom/broadcom/bt/util/mime4j/Log;->isDebugEnabled()Z
    ...
    sget-object v7, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->decodingSupported:Ljava/util/TreeSet;
    ...
    invoke-virtual {v5, v6}, Lcom/broadcom/bt/util/mime4j/Log;->debug(Ljava/lang/Object;)V
    ...
    sget-object v7, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->encodingSupported:Ljava/util/TreeSet;
    ...
    sput-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->US_ASCII:Ljava/nio/charset/Charset;
    ...
    sput-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->ISO_8859_1:Ljava/nio/charset/Charset;
    ...
    sput-object v5, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->UTF_8:Ljava/nio/charset/Charset;
...
.method public static getCharset(Ljava/lang/String;)Ljava/nio/charset/Charset;
    ...
    sget-object v3, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->log:Lcom/broadcom/bt/util/mime4j/Log;
    ...
    invoke-virtual {v3, v4}, Lcom/broadcom/bt/util/mime4j/Log;->info(Ljava/lang/Object;)V
...
.method public static isDecodingSupported(Ljava/lang/String;)Z
    ...
    .prologue
    .line 1172
    sget-object v0, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->decodingSupported:Ljava/util/TreeSet;
...
.method public static isEncodingSupported(Ljava/lang/String;)Z
    ...
    .prologue
    .line 1157
    sget-object v0, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->encodingSupported:Ljava/util/TreeSet;
...
.method public static isWhitespace(Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->isWhitespace(C)Z
...
.method public static toJavaCharset(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 1202
    sget-object v1, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil;->charsetMap:Ljava/util/HashMap;
    ...
    check-cast v0, Lcom/broadcom/bt/util/mime4j/util/CharsetUtil$Charset;
