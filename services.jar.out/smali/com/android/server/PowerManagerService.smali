...
.field static final ANIM_STEPS_FAST:I = 0x1

.field static final AUTOBRIGHTNESS_ANIM_STEPS:I = 0x7

.field private static final AUTO_BRIGHTNESS_FLAG:I = 0x3e8
...
.field private static final DEFAULT_SLIDER_VALUE:I = 0x82
...
.field private static final LONG_KEYLIGHT_DELAY:I = 0x5dc
...
.field private static final SCALE_EX:F = 1000.0f
...
.field private static mCurrentSlider:I
...
# instance fields
.field private BASE_MAX_V:F

.field private BASE_MIN_V:F

.field private LUX_INX_BASE_INCREASE:F

.field private MAX_LUX_INX:F

.field private MAX_V:F

.field private MIN_LUX_INX:F

.field private MIN_V:F

.field private final MY_PID:I

.field private final MY_UID:I

.field private SLOPE_BASE:F

.field private V_BASE_INCREASE:F
...
.field private mLastBrightnessBeforeAlc:I
...
.field private mOutdoorMaxBrightness:I
...
.field private mUserActivityEventType:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/PowerManagerService;->mCurrentSlider:I
...
.method constructor <init>()V
    ...
    .line 259
    iput v4, p0, Lcom/android/server/PowerManagerService;->mUserActivityEventType:I

    .line 264
    iput v5, p0, Lcom/android/server/PowerManagerService;->mLastBrightnessBeforeAlc:I
    ...
    .line 292
    iput v8, p0, Lcom/android/server/PowerManagerService;->MIN_LUX_INX:F

    .line 293
    const/high16 v2, 0x4362

    iput v2, p0, Lcom/android/server/PowerManagerService;->MAX_LUX_INX:F

    .line 294
    iput v8, p0, Lcom/android/server/PowerManagerService;->MIN_V:F

    .line 295
    const/high16 v2, 0x4362

    iput v2, p0, Lcom/android/server/PowerManagerService;->MAX_V:F

    .line 296
    iget v2, p0, Lcom/android/server/PowerManagerService;->MAX_V:F

    iget v3, p0, Lcom/android/server/PowerManagerService;->MIN_V:F
    ...
    iput v2, p0, Lcom/android/server/PowerManagerService;->BASE_MIN_V:F
    ...
    iput v2, p0, Lcom/android/server/PowerManagerService;->BASE_MAX_V:F

    .line 298
    iget v2, p0, Lcom/android/server/PowerManagerService;->BASE_MAX_V:F

    iget v3, p0, Lcom/android/server/PowerManagerService;->BASE_MIN_V:F

    sub-float/2addr v2, v3

    iput v2, p0, Lcom/android/server/PowerManagerService;->V_BASE_INCREASE:F

    .line 299
    iget v2, p0, Lcom/android/server/PowerManagerService;->MAX_LUX_INX:F

    iget v3, p0, Lcom/android/server/PowerManagerService;->MIN_LUX_INX:F

    sub-float/2addr v2, v3

    iput v2, p0, Lcom/android/server/PowerManagerService;->LUX_INX_BASE_INCREASE:F

    .line 300
    const/high16 v2, 0x447a

    iget v3, p0, Lcom/android/server/PowerManagerService;->V_BASE_INCREASE:F

    mul-float/2addr v2, v3

    iget v3, p0, Lcom/android/server/PowerManagerService;->LUX_INX_BASE_INCREASE:F

    div-float/2addr v2, v3

    iput v2, p0, Lcom/android/server/PowerManagerService;->SLOPE_BASE:F
...
.method private applyButtonState(I)I
    ...
    sget-boolean v1, Lcom/lge/config/ConfigBuildFlags;->CAPP_KEY_LIGHT_OFF:Z
...
.method private getPreferredBrightness()I
    ...
    invoke-direct {p0, v2}, Lcom/android/server/PowerManagerService;->setAlcInterpolationParam(I)I
...
.method private lightSensorChangedLocked(I)V
    ...
    .line 2669
    sget-boolean v3, Lcom/lge/config/ConfigBuildFlags;->CAPP_KEY_LIGHT_OFF:Z
...
.method private setAlcInterpolationParam(I)I
    .locals 11
    .parameter "level"
    ...
    .line 2855
    .local v0, SNAP_MARGIN:I
    const/16 v1, 0x6e

    .line 2856
    .local v1, calucaltedLevel:I
    ...
    .line 2860
    .local v4, getBnR:F
    sget v7, Lcom/android/server/PowerManagerService;->mCurrentSlider:I
    ...
    iget v8, p0, Lcom/android/server/PowerManagerService;->MIN_LUX_INX:F
    ...
    sput v7, Lcom/android/server/PowerManagerService;->mCurrentSlider:I
    :try_end_0
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v9, "setAlcInterpolationParam level= "
    ...
    const-string v9, ",mCurrentSlider= "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    sget v9, Lcom/android/server/PowerManagerService;->mCurrentSlider:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, ",outdoorMaxBrightness:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/server/PowerManagerService;->mOutdoorMaxBrightness:I
    ...
    .line 2874
    iget p1, p0, Lcom/android/server/PowerManagerService;->mLastBrightnessBeforeAlc:I

    .line 2876
    :cond_1
    iget v7, p0, Lcom/android/server/PowerManagerService;->mOutdoorMaxBrightness:I

    if-le p1, v7, :cond_2

    iget v7, p0, Lcom/android/server/PowerManagerService;->MAX_LUX_INX:F
    ...
    sget p1, Lcom/android/server/PowerManagerService;->mCurrentSlider:I
    ...
    .line 2880
    iget v7, p0, Lcom/android/server/PowerManagerService;->MIN_LUX_INX:F
    ...
    .line 2888
    iget v7, p0, Lcom/android/server/PowerManagerService;->MIN_V:F

    iget v8, p0, Lcom/android/server/PowerManagerService;->MIN_V:F
    ...
    iget v8, p0, Lcom/android/server/PowerManagerService;->MAX_V:F
    ...
    .line 2896
    :cond_5
    iget v7, p0, Lcom/android/server/PowerManagerService;->MAX_V:F
    ...
    iget v8, p0, Lcom/android/server/PowerManagerService;->MAX_LUX_INX:F

    iget v9, p0, Lcom/android/server/PowerManagerService;->MIN_LUX_INX:F
...
.method private setLightBrightness(II)V
    ...
    .line 2185
    iput p2, p0, Lcom/android/server/PowerManagerService;->mLastBrightnessBeforeAlc:I

    .line 2186
    iget-object v1, p0, Lcom/android/server/PowerManagerService;->mLcdLight:Lcom/android/server/LightsService$Light;

    invoke-direct {p0, p2}, Lcom/android/server/PowerManagerService;->setAlcInterpolationParam(I)I
...
.method private setPowerState(IZI)V
    ...
    iget v11, p0, Lcom/android/server/PowerManagerService;->mScreenOffTimeoutSetting:I
...
.method private setScreenOffTimeoutsLocked()V
    ...
    const-string v3, " mKeyledTimeoutDelay="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/PowerManagerService;->mKeyledTimeoutDelay:I

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, " mKeylightDelay="
...
.method private userActivity(JJZIZ)V
    ...
    iput v0, p0, Lcom/android/server/PowerManagerService;->mUserActivityEventType:I
...
.method public getBacklightBrightness()I
    ...
    .line 3168
    .local v0, ret:I
    iget v1, p0, Lcom/android/server/PowerManagerService;->m_brightness:I
...
.method initInThread()V
    ...
    iput v1, p0, Lcom/android/server/PowerManagerService;->mOutdoorMaxBrightness:I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput v1, p0, Lcom/android/server/PowerManagerService;->MIN_LUX_INX:F
    ...
    iput v1, p0, Lcom/android/server/PowerManagerService;->MIN_V:F

    .line 662
    iget v1, p0, Lcom/android/server/PowerManagerService;->mOutdoorMaxBrightness:I

    int-to-float v1, v1

    iput v1, p0, Lcom/android/server/PowerManagerService;->MAX_LUX_INX:F
    ...
    iput v1, p0, Lcom/android/server/PowerManagerService;->MAX_V:F
    ...
    const-string v3, "outdoorMaxBrightness"

    invoke-static {v1, v3, v6}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public setBacklightBrightness(I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/PowerManagerService;->setAlcInterpolationParam(I)I
    ...
    .line 3197
    sget-boolean v3, Lcom/lge/config/ConfigBuildFlags;->CAPP_KEYLED_TIMEOUT:Z
    ...
    const-string v7, "2 AUTO_BRIGHTNESS_FLAG "
...
.method public userActivity_legacy(JZ)V
    .locals 8
    .parameter "time"
    .parameter "noChangeLights"
