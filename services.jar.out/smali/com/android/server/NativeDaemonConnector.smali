...
.method private sendCommandLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/android/server/NativeDaemonConnector;->mWifiServiceExt:Lcom/lge/wifi_iface/WifiServiceExtIface;

    if-eqz v2, :cond_4

    iget-object v2, p0, Lcom/android/server/NativeDaemonConnector;->mWifiServiceExt:Lcom/lge/wifi_iface/WifiServiceExtIface;

    invoke-interface {v2, v0}, Lcom/lge/wifi_iface/WifiServiceExtIface;->isHotspotSSIDKSC5601(Ljava/lang/StringBuilder;)Z
