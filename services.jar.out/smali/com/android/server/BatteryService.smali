...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/BatteryService$batteryCheckHandler;
    }
.end annotation
...
.field static final CHECK_BATTERY_STATUS_VALID_BATTERY_SHUTDOWN:I = 0x1
...
# instance fields
.field private final SHOW_SHUTDOWN_DIALOG:I

.field private final SHUTDOWN:I
...
.field private mBatteryWirelessCharging:I
...
.field private mHandler:Lcom/android/server/BatteryService$batteryCheckHandler;
...
.field private mLastBatteryWirelessCharging:I
...
.field private shutdown_dialog:Landroid/app/AlertDialog;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    iput v0, p0, Lcom/android/server/BatteryService;->SHUTDOWN:I

    .line 154
    const/4 v0, 0x3

    iput v0, p0, Lcom/android/server/BatteryService;->SHOW_SHUTDOWN_DIALOG:I

    .line 155
    iput-object v5, p0, Lcom/android/server/BatteryService;->shutdown_dialog:Landroid/app/AlertDialog;

    .line 158
    iput v4, p0, Lcom/android/server/BatteryService;->mBatteryWirelessCharging:I

    .line 159
    iput v4, p0, Lcom/android/server/BatteryService;->mLastBatteryWirelessCharging:I
    ...
    .line 181
    :cond_0
    new-instance v0, Lcom/android/server/BatteryService$batteryCheckHandler;

    invoke-direct {v0, p0, v5}, Lcom/android/server/BatteryService$batteryCheckHandler;-><init>(Lcom/android/server/BatteryService;Lcom/android/server/BatteryService$1;)V

    iput-object v0, p0, Lcom/android/server/BatteryService;->mHandler:Lcom/android/server/BatteryService$batteryCheckHandler;
...
.method static synthetic access$300(Lcom/android/server/BatteryService;)Lcom/android/server/BatteryService$batteryCheckHandler;
    .locals 1
    .parameter "x0"

    .prologue
    .line 88
    iget-object v0, p0, Lcom/android/server/BatteryService;->mHandler:Lcom/android/server/BatteryService$batteryCheckHandler;
...
.method static synthetic access$500(Lcom/android/server/BatteryService;)Landroid/app/AlertDialog;
    ...
    .prologue
    .line 88
    iget-object v0, p0, Lcom/android/server/BatteryService;->shutdown_dialog:Landroid/app/AlertDialog;
...
.method static synthetic access$502(Lcom/android/server/BatteryService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    ...
    .prologue
    .line 88
    iput-object p1, p0, Lcom/android/server/BatteryService;->shutdown_dialog:Landroid/app/AlertDialog;
...
.method private processValues()V
    ...
    .line 395
    const-string v0, "persist.sys.high_temp_off"
    ...
    .line 377
    :cond_f
    iget v0, p0, Lcom/android/server/BatteryService;->mBatteryWirelessCharging:I
...
.method private final sendIntent()V
    ...
    .line 540
    :cond_0
    iget v2, p0, Lcom/android/server/BatteryService;->mLastBatteryWirelessCharging:I

    iget v3, p0, Lcom/android/server/BatteryService;->mBatteryWirelessCharging:I

    if-ne v2, v3, :cond_1

    .line 541
    const-string v2, "wireless-charging"
    ...
    const-string v4, " Battery ID:"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/BatteryService;->mValidBatteryID:I

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, " mBatteryWirelessCharging:"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/BatteryService;->mBatteryWirelessCharging:I
    ...
    .line 543
    :cond_1
    iget v2, p0, Lcom/android/server/BatteryService;->mBatteryWirelessCharging:I

    iput v2, p0, Lcom/android/server/BatteryService;->mLastBatteryWirelessCharging:I
...
.method private final shutdownIfNoPower()V
    ...
    iget-object v1, p0, Lcom/android/server/BatteryService;->mHandler:Lcom/android/server/BatteryService$batteryCheckHandler;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/BatteryService$batteryCheckHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    const-string v1, "shutdownIfNoPower() will show shutdown animation"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget v1, p0, Lcom/android/server/BatteryService;->mValidBatteryID:I
...
.method final isPowered()Z
    ...
    iget v1, p0, Lcom/android/server/BatteryService;->mBatteryWirelessCharging:I
