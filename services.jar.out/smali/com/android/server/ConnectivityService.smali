...
.method static constructor <clinit>()V
    ...
    .line 418
    sput-boolean v0, Lcom/android/server/ConnectivityService;->mJustIsWifiConnected:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    .line 470
    new-instance v2, Lcom/android/internal/telephony/LGfeature;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/ConnectivityService;->featureset:Ljava/lang/String;

    move-object/from16 v0, p1

    invoke-direct {v2, v0, v3}, Lcom/android/internal/telephony/LGfeature;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v1}, Lcom/android/server/ConnectivityService;->isSupportType(II)Z
    ...
    iget-object v6, v0, Lcom/android/server/ConnectivityService;->mLGfeature:Lcom/android/internal/telephony/LGfeature;

    move/from16 v0, v25

    invoke-direct {v3, v0, v5, v6}, Landroid/net/MobileDataStateTracker;-><init>(ILjava/lang/String;Lcom/android/internal/telephony/LGfeature;)V
...
.method private deleteDefualt_DNS()V
    .locals 10
...
.method private handleConnect(Landroid/net/NetworkInfo;)V
    ...
    iget-boolean v5, v5, Lcom/android/internal/telephony/LGfeature;->MMS_MOBILE_OFF:Z
    ...
    const-string v6, "[LGE_DATA] handleConnect() : mJustIsWifiConnected = true"

    invoke-static {v5, v6}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2953
    sput-boolean v7, Lcom/android/server/ConnectivityService;->mJustIsWifiConnected:Z
    ...
    iget-object v5, p0, Lcom/android/server/ConnectivityService;->featureset:Ljava/lang/String;
    ...
    .line 2966
    const-string v5, "[LG_DATA]WIFI IS CONNECTED"
...
.method private handleConnectionFailure(Landroid/net/NetworkInfo;)V
    ...
    const-string v8, "handleConnectionFailure: mIsWifiConnected = false"
...
.method private handleConnectivityChange(IZ)V
    ...
    invoke-direct {p0, v10, v4, v13, v14}, Lcom/android/server/ConnectivityService;->updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;ZLcom/android/server/ConnectivityService$RouteAttributes;)Z
    ...
    iget-boolean v13, v13, Lcom/android/internal/telephony/LGfeature;->MMS_MOBILE_OFF:Z
    ...
    const-string v14, "[LGE_DATA] Remove default DNS not to allow other apps. to do DNS query Except for MMS."

    invoke-static {v13, v14}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 3173
    sget-boolean v13, Lcom/android/server/ConnectivityService;->mJustIsWifiConnected:Z

    if-nez v13, :cond_c

    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->deleteDefualt_DNS()V
...
.method private handleDisconnect(Landroid/net/NetworkInfo;)V
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/LGfeature;->MMS_MOBILE_OFF:Z
    ...
    const-string v20, "[LGE_DATA] handleDisconnect() : mJustIsWifiConnected = false"
    ...
    sput-boolean v19, Lcom/android/server/ConnectivityService;->mJustIsWifiConnected:Z
    ...
    const-string v20, "[LGE_DATA][handleDisconnect] Reason:"
    ...
    const-string v20, ", networkTypeName:"
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/LGfeature;->SUPPORT_RETAIN_SOCKET_CONN_IN_OOS:Z
...
.method private isSignedFromVZW()Z
    ...
    const-string v17, "SecureSetting caller UID: "
    ...
    const-string v15, "com.verizon.permissions.vzwappapn"
    ...
    .line 1338
    .local v14, sigpi:Landroid/content/pm/PackageInfo;
    invoke-virtual {v12, v3}, Landroid/content/pm/PackageManager;->getPackagesForUid(I)[Ljava/lang/String;

    move-result-object v5

    .line 1339
    .local v5, callerpkgs:[Ljava/lang/String;
    if-nez v5, :cond_0

    const/4 v15, 0x0

    .line 1376
    .end local v3           #caller:I
    .end local v5           #callerpkgs:[Ljava/lang/String;
    .end local v12           #pm:Landroid/content/pm/PackageManager;
    .end local v14           #sigpi:Landroid/content/pm/PackageInfo;
    :goto_0
    return v15

    .line 1341
    .restart local v3       #caller:I
    .restart local v5       #callerpkgs:[Ljava/lang/String;
    .restart local v12       #pm:Landroid/content/pm/PackageManager;
    .restart local v14       #sigpi:Landroid/content/pm/PackageInfo;
    :cond_0
    move-object v1, v5
    ...
    const-string v17, "SecureSetting pkg: "
    ...
    const-string v16, "cequint is only  false"
    ...
    .line 1359
    .local v4, callerpi:Landroid/content/pm/PackageInfo;
    ...
    invoke-virtual {v13, v15}, Landroid/content/pm/Signature;->equals(Ljava/lang/Object;)Z
    ...
    const-string v16, "SecureSetting it\'s a match"
    ...
    .end local v3           #caller:I
    .end local v4           #callerpi:Landroid/content/pm/PackageInfo;
    .end local v5           #callerpkgs:[Ljava/lang/String;
    .end local v8           #i$:I
    .end local v10           #len$:I
    ...
    const-string v16, "SecureSetting oops didn\'t find a match"
...
.method private networkToInt(Ljava/lang/String;)I
    .locals 2
    .parameter "networkType"
    ...
    .line 2525
    :cond_1
    const-string v1, "mobile_data_ims"
    ...
    .line 2527
    :cond_2
    const-string v1, "mobile_data_admin"
    ...
    .line 2529
    :cond_3
    const-string v1, "mobile_data_vzwapp"
...
.method private networkToString(I)Ljava/lang/String;
    .locals 1
    .parameter "networkType"
    ...
    .line 2541
    :sswitch_1
    const-string v0, "mobile_data_ims"

    goto :goto_0

    .line 2543
    :sswitch_2
    const-string v0, "mobile_data_admin"

    goto :goto_0

    .line 2545
    :sswitch_3
    const-string v0, "mobile_data_vzwapp"
...
.method private stopUsingNetworkFeature(Lcom/android/server/ConnectivityService$FeatureUser;Z)I
    ...
    invoke-virtual {v0, v8, v6}, Lcom/android/server/ConnectivityService;->convertFeatureToNetworkType(ILjava/lang/String;)I
    ...
    invoke-virtual {v14, v11, v9, v12}, Lmiui/net/FirewallManager;->onStopUsingNetworkFeature(III)V
    ...
    iget-object v14, v0, Lcom/android/server/ConnectivityService;->mLGfeature:Lcom/android/internal/telephony/LGfeature;

    iget-boolean v14, v14, Lcom/android/internal/telephony/LGfeature;->SUPPORT_INHIBIT_APN_CHANGE:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v15, "access_point_conversion"

    invoke-static {v14, v15}, Lcom/lge/provider/SettingsEx$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0
    ...
    const-string v15, "[stopUsingNetworkFeature] SAFETYMODE:"
    ...
    const-string v15, "[stopUsingNetworkFeature] usedNetworkType("
    ...
    const-string v15, ") is not connecting or connected.. so return"
    ...
    const-string v15, ") is connecting or connected.. so teardown"
    ...
    iget-boolean v14, v14, Lcom/android/internal/telephony/LGfeature;->IPv6_block_handle_by_SDM:Z
    ...
    iget-boolean v14, v14, Lcom/android/internal/telephony/LGfeature;->MMS_RETRY_CONNECTION:Z
    ...
    iget-boolean v14, v0, Lcom/android/server/ConnectivityService$FeatureUser;->mIsExpired:Z
    ...
    const-string v14, "android.net.conn.MMS_CONNECTIVITY_REQUEST_EXPIRED"
...
.method private tryFailover(I)V
    ...
    invoke-static {v5}, Lcom/android/internal/telephony/DataConnectionManager;->getInstance(Landroid/content/Context;)Lcom/android/internal/telephony/DataConnectionManager;

    move-result-object v3

    .line 2727
    .local v3, dataMgr:Lcom/android/internal/telephony/DataConnectionManager;
    iget-object v5, p0, Lcom/android/server/ConnectivityService;->mNetConfigs:[Landroid/net/NetworkConfig;
    ...
    const-string v6, "[LG_DATA]switchTo.getTypeName() = "
    ...
    const-string v6, " previous net type = "
    ...
    iget-boolean v5, p0, Lcom/android/server/ConnectivityService;->mIsWifiConnected:Z
    ...
    const-string v6, "[LG_DATA]mIsWifiConnected = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v6, p0, Lcom/android/server/ConnectivityService;->mIsWifiConnected:Z

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, " getDataNetworkMode() = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    invoke-virtual {v3, v8}, Lcom/android/internal/telephony/DataConnectionManager;->getDataNetworkMode(Z)I
    ...
    const-string v6, "data_network_user_paypopup_transition_from_wifi_to_mobile"
    ...
    const-string v5, "lge.intent.action.LGE_WIFI_3G_TRANSITION"

    invoke-direct {v4, v5}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 2784
    .local v4, intentWifi3GTransition:Landroid/content/Intent;
    iget-object v5, p0, Lcom/android/server/ConnectivityService;->mContext:Landroid/content/Context;

    invoke-virtual {v5, v4}, Landroid/content/Context;->sendBroadcast(Landroid/content/Intent;)V

    .line 2786
    .end local v4           #intentWifi3GTransition:Landroid/content/Intent;
    :cond_6
    iput-boolean v8, p0, Lcom/android/server/ConnectivityService;->mIsWifiConnected:Z
...
.method private writePidDns(Ljava/util/Collection;I)Z
    ...
    iget-object v6, p0, Lcom/android/server/ConnectivityService;->mLGfeature:Lcom/android/internal/telephony/LGfeature;

    iget-boolean v6, v6, Lcom/android/internal/telephony/LGfeature;->Mobile_MMS_DNS_QUERY:Z
...
.method private writePidtoProperty()V
    .locals 12
    ...
    .line 4727
    .local v8, pids_string:Ljava/lang/String;
    iget-object v0, p0, Lcom/android/server/ConnectivityService;->mPriorityList:[I
    ...
    const-string v11, "Current pids not using InternetPDN are "
    ...
    .line 4740
    const-string v9, "ril.current.notinternet"
...
.method public getAllNetworkInfo()[Landroid/net/NetworkInfo;
    ...
    const-string v9, "[jlee] t.getNetworkInfo() "
...
.method public getAuthentecVpnInfo()Lcom/android/internal/net/LegacyVpnInfo;
    .locals 1

    .prologue
    .line 4291
    iget-object v0, p0, Lcom/android/server/ConnectivityService;->mInfo:Lcom/android/internal/net/LegacyVpnInfo;
...
.method public getMobileDataEnabledForEachPdn(I)Z
    ...
    .line 2285
    invoke-direct {p0, p1}, Lcom/android/server/ConnectivityService;->networkToString(I)Ljava/lang/String;

    move-result-object v1

    .line 2286
    .local v1, strNetwork:Ljava/lang/String;
    invoke-direct {p0, p1}, Lcom/android/server/ConnectivityService;->isValidNetwork(I)Z
    ...
    .line 2293
    .local v0, retVal:Z
    const-string v4, "mobile_data_ims"
    ...
    invoke-static {v4, v1, v2}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    const-string v4, "getMobileDataEnabled returning "
...
.method public getNetworkInfo(I)Landroid/net/NetworkInfo;
    ...
    const-string v6, " mSignedFromVZW : "
    ...
    const-string v6, " mContainVzwAppApn_MetaTag : "
    ...
    const-string v6, "getNetworkInfo set from "
    ...
    :cond_0
    :goto_0
    invoke-direct {p0, p1, v3}, Lcom/android/server/ConnectivityService;->getNetworkInfo(II)Landroid/net/NetworkInfo;
...
.method public isNetworkSKT_formccmnc()Z
    ...
    .line 1231
    .local v0, prop_mccmnc1:Ljava/lang/String;
    ...
    .line 1232
    .local v1, prop_mccmnc2:Ljava/lang/String;
    const-string v2, "ConnectivityService"
    ...
    const-string v4, "[LGE_DATA] USIM_MCC_MNC = "
...
.method public isSupportType(II)Z
    ...
    const-string v2, "[LGFeature] it is not support, type: "
...
.method public requestRouteToHost(II)Z
    ...
    .line 2038
    .local v3, mSystemImage:Z
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->isSignedFromVZW()Z

    move-result v2

    .line 2039
    .local v2, mSignedFromVZW:Z
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->isContainVzwAppApn_MetaTag()Z

    move-result v1

    .line 2041
    .local v1, mContainVzwAppApn_MetaTag:Z
    const-string v4, "ConnectivityService"
    ...
    const-string v6, "requestRouteToHost set from "
    ...
    .line 2075
    .end local v1           #mContainVzwAppApn_MetaTag:Z
    .end local v2           #mSignedFromVZW:Z
    .end local v3           #mSystemImage:Z
    :cond_1
    :goto_1
    ...
    invoke-virtual {p0, p1, v4}, Lcom/android/server/ConnectivityService;->requestRouteToHostAddress(I[B)Z
    ...
    .line 2048
    .restart local v1       #mContainVzwAppApn_MetaTag:Z
    .restart local v2       #mSignedFromVZW:Z
    .restart local v3       #mSystemImage:Z
    :cond_2
    if-nez v3, :cond_3
...
.method public requestRouteToHostAddress(I[B)Z
    ...
    .line 2093
    .local v5, mSystemImage:Z
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->isSignedFromVZW()Z

    move-result v4

    .line 2094
    .local v4, mSignedFromVZW:Z
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->isContainVzwAppApn_MetaTag()Z

    move-result v3

    .line 2096
    .local v3, mContainVzwAppApn_MetaTag:Z
    const-string v9, "ConnectivityService"
    ...
    const-string v11, " mSignedFromVZW : "
    ...
    const-string v11, " mContainVzwAppApn_MetaTag : "
    ...
    const-string v11, "requestRouteToHost set from "
    ...
    .line 2129
    .end local v3           #mContainVzwAppApn_MetaTag:Z
    .end local v4           #mSignedFromVZW:Z
    .end local v5           #mSystemImage:Z
    :cond_0
    :goto_0
    ...
    const-string v10, "requestRouteToHostAddress on network: "
    ...
    .line 2103
    .restart local v3       #mContainVzwAppApn_MetaTag:Z
    .restart local v4       #mSignedFromVZW:Z
    .restart local v5       #mSystemImage:Z
    :cond_2
    if-nez v5, :cond_3
...
.method public setAuthentecVpnInfo(Lcom/android/internal/net/LegacyVpnInfo;)V
    .locals 0
    .parameter "info"

    .prologue
    .line 4287
    iput-object p1, p0, Lcom/android/server/ConnectivityService;->mInfo:Lcom/android/internal/net/LegacyVpnInfo;
...
.method public setAutomationTether(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/connectivity/Tethering;->setAutomationTether(Z)V
...
.method public setMobileDataEnabled(Z)V
    ...
    invoke-interface {v2, v4}, Lcom/lge/cappuccino/IMdm;->getAllowMobileNetwork(Landroid/content/ComponentName;)Z
    ...
    .line 2428
    const-string v2, "LGMDM DATA_NETWORK_USER_SETTING lock"
    ...
    iget-boolean v2, v2, Lcom/android/internal/telephony/LGfeature;->NOTI_GPRS_REJECT:Z
    ...
    const-string v4, " [LGE_DATA] reject_cause = "
    ...
    .line 2447
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/DataConnectionManager;->handleNetworkRejection(I)V

    .line 2457
    .end local v0           #dataMgr:Lcom/android/internal/telephony/DataConnectionManager;
    ...
    .line 2453
    .restart local v0       #dataMgr:Lcom/android/internal/telephony/DataConnectionManager;
    :cond_2
    invoke-virtual {v0, v3}, Lcom/android/internal/telephony/DataConnectionManager;->functionForPacketDrop(Z)V
...
.method public declared-synchronized setMobileDataEnabledForEachPdn(IZ)V
    .locals 4
    .parameter "networkType"
    .parameter "enabled"
    ...
    .line 2480
    .local v0, strNetwork:Ljava/lang/String;
    const-string v1, "ConnectivityService"
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, p1}, Lcom/android/server/ConnectivityService;->getMobileDataEnabledForEachPdn(I)Z
    ...
    .line 2478
    .end local v0           #strNetwork:Ljava/lang/String;
    :catchall_0
    move-exception v1
    ...
    .line 2492
    .restart local v0       #strNetwork:Ljava/lang/String;
    :cond_2
    const/4 v1, 0x0
    ...
    invoke-interface {v1}, Landroid/net/NetworkStateTracker;->teardown()Z
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public setUpdateNetworkSettings()V
    ...
    const-string v1, "setUpdateNetworkSettings"
...
.method public startUsingNetworkFeature(ILjava/lang/String;Landroid/os/IBinder;)I
    ...
    invoke-static/range {v27 .. v27}, Lcom/android/internal/telephony/DataConnectionManager;->getInstance(Landroid/content/Context;)Lcom/android/internal/telephony/DataConnectionManager;

    move-result-object v8

    .line 1426
    .local v8, dataMgr:Lcom/android/internal/telephony/DataConnectionManager;
    new-instance v27, Ljava/lang/StringBuilder;

    invoke-direct/range {v27 .. v27}, Ljava/lang/StringBuilder;-><init>()V

    const-string v28, "startUsingNetworkFeature for net "
    ...
    invoke-interface/range {v27 .. v28}, Lcom/lge/cappuccino/IMdm;->getAllowSendingSms(Landroid/content/ComponentName;)Z

    move-result v27

    if-nez v27, :cond_0

    const-string v27, "enableMMS"
    ...
    invoke-interface/range {v27 .. v28}, Lcom/lge/cappuccino/IMdm;->isAllowSendMMS(Landroid/content/ComponentName;)Z

    .line 1432
    const-string v27, "ConnectivityService"

    const-string v28, "Block Sending SMS in ConnectivityService"
    ...
    const-string v28, "Invalid nettype return APN_REQUEST_FAILED"
    ...
    const-string v29, "[LGE_DATA-KAF] data_roaming ="
    ...
    const-string v29, "[LGE_DATA-KAF] gsm.operator.isroaming ="
    ...
    const-string v29, "[LGE_DATA-KAF] data_restrict_mode ="
    ...
    invoke-virtual {v8, v0}, Lcom/android/internal/telephony/DataConnectionManager;->getDataNetworkMode(Z)I
    ...
    const-string v29, "[LGE_DATA-KAF] ni.isAvailable() = "
    ...
    .restart local v9       #data_roaming:I
    .restart local v19       #network:Landroid/net/NetworkStateTracker;
    .restart local v20       #ni:Landroid/net/NetworkInfo;
    :cond_3
    const/16 v27, 0x0
    ...
    const-string v28, "special network not available"
    ...
    const-string v28, "special network already active"
    ...
    const-string v28, "special network already connecting"
    ...
    const-string v28, "special network is not connected"
    ...
    .line 1518
    .local v13, isMobileDataEnabled:Z
    const/16 v27, 0x0
    ...
    const-string v29, "[LGE_DATA] <startUsingNetworkFeatureId()> isMobileDataAllowed : "
    ...
    .line 1525
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/ConnectivityService;->isNetworkRoaming()Z
    ...
    .line 1527
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/ConnectivityService;->isAllowRoaming()Z
    ...
    const-string v28, "[LGE_DATA] <startUsingNetworkFeatureId()> Roaming : return."
    ...
    const-string v27, "android.net.conn.STARTING_IN_ROAM_SETTING_DISABLE"
    ...
    const-string v28, "[LGE_DATA] <startUsingNetworkFeatureId()> Roaming : pass."
    ...
    const-string v28, "[LGE_DATA] <startUsingNetworkFeatureId()> Mobile Data is NOT enabled."
    ...
    const-string v29, "[LGE_DATA] isNetworkSKT_formccmnc = "

    invoke-virtual/range {v28 .. v29}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v28

    invoke-virtual/range {p0 .. p0}, Lcom/android/server/ConnectivityService;->isNetworkSKT_formccmnc()Z
    ...
    const-string v27, "android.net.conn.STARTING_IN_DATA_SETTING_DISABLE_3GONLY"
    ...
    .line 1568
    .end local v6           #broadcast:Landroid/content/Intent;
    .end local v13           #isMobileDataEnabled:Z
    :cond_d
    move-object/from16 v0, p0
    ...
    const-string v29, " mSignedFromVZW : "
    ...
    const-string v29, " mContainVzwAppApn_MetaTag : "
    ...
    const-string v29, "feature set from "
    ...
    .line 1606
    .end local v14           #mContainVzwAppApn_MetaTag:Z
    .end local v15           #mSignedFromVZW:Z
    .end local v16           #mSystemImage:Z
    :cond_f
    :goto_1
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/net/NetworkInfo;->getState()Landroid/net/NetworkInfo$State;

    move-result-object v18

    .line 1622
    .local v18, mobile_state:Landroid/net/NetworkInfo$State;
    const-string v27, "ConnectivityService"
    ...
    const-string v29, "call StartUsnigNetworkFeature by IMS, mIsWifiConnected = "
    ...
    const-string v29, "Can\'t call StartUsnigNetworkFeature because of, mIsWifiConnected = "
    ...
    .end local v18           #mobile_state:Landroid/net/NetworkInfo$State;
    .end local v19           #network:Landroid/net/NetworkStateTracker;
    .end local v26           #usedNetworkType:I
    .restart local v14       #mContainVzwAppApn_MetaTag:Z
    .restart local v15       #mSignedFromVZW:Z
    .restart local v16       #mSystemImage:Z
    :cond_13
    if-nez v16, :cond_14
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/LGfeature;->SUPPORT_INHIBIT_APN_CHANGE:Z
    ...
    const-string v28, "access_point_conversion"

    invoke-static/range {v27 .. v28}, Lcom/lge/provider/SettingsEx$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    .line 1650
    .local v17, mobileNetwork:Landroid/net/NetworkStateTracker;
    new-instance v27, Ljava/lang/StringBuilder;

    invoke-direct/range {v27 .. v27}, Ljava/lang/StringBuilder;-><init>()V

    const-string v28, "[startUsingNetworkFeature] SAFETYMODE:"
    ...
    invoke-virtual/range {v28 .. v28}, Landroid/net/NetworkInfo;->isConnectedOrConnecting()Z
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/net/NetworkInfo;->isConnectedOrConnecting()Z
    ...
    aget-object v19, v27, v28

    .line 1657
    const/16 v26, 0x0

    .line 1663
    .end local v4           #SAFETYMODE:I
    .end local v17           #mobileNetwork:Landroid/net/NetworkStateTracker;
    :cond_19
    invoke-interface/range {v19 .. v19}, Landroid/net/NetworkStateTracker;->getNetworkInfo()Landroid/net/NetworkInfo;
    ...
    const-string v29, "[LGE_DATA] just pass MMS when 3G is blocked, mode = "
    ...
    invoke-virtual/range {v31 .. v34}, Lmiui/net/FirewallManager;->onStartUsingNetworkFeature(III)V
    ...
    .line 1736
    const-string v27, "if TYPE_MOBILE_HIPRI , 60sec timer is not set"
    ...
    .line 1774
    const-string v27, "special network already active"
    ...
    const-string v28, "SettingNotFoundException:"
    ...
    .line 1676
    const-string v27, "special network not available"
    ...
    .line 1677
    const-string v27, "enableDUNAlways"
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/LGfeature;->SUPPORT_DOCOMO_TETHER:Z
    ...
    .line 1740
    :cond_22
    const-string v27, "60sec timer is set!!!"
    ...
    .line 1750
    const-string v27, "if TYPE_MOBILE_DUN , 60sec timer is not set"
    ...
    .end local v23           #token:J
    :cond_26
    const-string v27, "special network already connecting"
    ...
    const-string v28, "startUsingNetworkFeature reconnecting to "
...
.method public stopUsingNetworkFeature(ILjava/lang/String;)I
    ...
    .line 1823
    .local v6, u:Lcom/android/server/ConnectivityService$FeatureUser;
    const/4 v0, 0x0
    ...
    .line 1829
    .local v4, mSystemImage:Z
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->isSignedFromVZW()Z

    move-result v3

    .line 1830
    .local v3, mSignedFromVZW:Z
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->isContainVzwAppApn_MetaTag()Z

    move-result v2

    .line 1832
    .local v2, mContainVzwAppApn_MetaTag:Z
    ...
    const-string v12, "stopUsingNetworkFeature mSystemImage : "
    ...
    const-string v12, " mSignedFromVZW : "
    ...
    const-string v12, " mContainVzwAppApn_MetaTag : "
    ...
    const-string v12, "stopUsingNetworkFeature feature set from "
    ...
    .line 1865
    .end local v2           #mContainVzwAppApn_MetaTag:Z
    .end local v3           #mSignedFromVZW:Z
    .end local v4           #mSystemImage:Z
    :cond_1
    :goto_0
    monitor-enter p0
    ...
    invoke-virtual {v8, v5, v7, p1, p2}, Lcom/android/server/ConnectivityService$FeatureUser;->isSameUser(IIILjava/lang/String;)Z
    ...
    .line 1876
    invoke-direct {p0, v6, v9}, Lcom/android/server/ConnectivityService;->stopUsingNetworkFeature(Lcom/android/server/ConnectivityService$FeatureUser;Z)I
    ...
    .restart local v2       #mContainVzwAppApn_MetaTag:Z
    .restart local v3       #mSignedFromVZW:Z
    .restart local v4       #mSystemImage:Z
    :cond_4
    if-nez v4, :cond_5
    ...
    :cond_8
    const-string v10, "stopUsingNetworkFeature - not a live request, ignoring"
...
.method public tether(Ljava/lang/String;)I
    ...
    invoke-interface {v1, v5, v2}, Lcom/lge/cappuccino/IMdm;->checkDisabledSystemService(Landroid/content/ComponentName;Ljava/lang/String;)Z
