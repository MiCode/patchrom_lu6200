...
.method private adjustStatusBarCarModeLocked()V
    ...
    iput-object v4, p0, Lcom/android/server/UiModeManagerService;->mStatusBarManager:Landroid/app/StatusBarManager;
    ...
    .line 616
    iget-object v6, p0, Lcom/android/server/UiModeManagerService;->mStatusBarManager:Landroid/app/StatusBarManager;
    ...
    :goto_0
    invoke-virtual {v6, v4}, Landroid/app/StatusBarManager;->disable(I)V

    .line 621
    :cond_1
    iget-object v4, p0, Lcom/android/server/UiModeManagerService;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    iput-object v4, p0, Lcom/android/server/UiModeManagerService;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    const-string v0, "com.lge.carhome"

    .line 630
    .local v0, carHome:Ljava/lang/String;
    iget-boolean v4, p0, Lcom/android/server/UiModeManagerService;->mCarModeEnabled:Z
    ...
    const-class v6, Lcom/android/internal/app/DisableCarModeActivity;

    invoke-direct {v1, v4, v6}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    .line 634
    .local v1, carModeOffIntent:Landroid/content/Intent;
    ...
    iget-object v8, p0, Lcom/android/server/UiModeManagerService;->mContext:Landroid/content/Context;

    invoke-static {v8, v5, v1, v5}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v8

    invoke-virtual {v2, v4, v6, v7, v8}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    .line 649
    .end local v0           #carHome:Ljava/lang/String;
    .end local v1           #carModeOffIntent:Landroid/content/Intent;
    ...
    .line 646
    .restart local v0       #carHome:Ljava/lang/String;
