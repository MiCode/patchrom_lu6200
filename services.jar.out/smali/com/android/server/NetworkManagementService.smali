...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->debug_interfaceName:Ljava/lang/String;

    .line 2057
    const-string v0, ""

    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->returnValue:Ljava/lang/String;
...
.method private getSecurityType(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    ...
    .line 1482
    :pswitch_0
    sget-boolean v0, Lcom/lge/wifi/WifiLgeConfig;->CONFIG_LGE_WLAN_QCOM_PATCH:Z
...
# virtual methods
.method public LGE_WIFI_RFT_Test_API(Ljava/lang/String;)Z
    .locals 7
    .parameter "command"
    ...
    const-string v6, "lge_wifi_rft_api "
    ...
    iput-object v4, p0, Lcom/android/server/NetworkManagementService;->returnValue:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/server/NetworkManagementService;->returnValue:Ljava/lang/String;
    ...
    const-string v6, "LGE_WIFI_RFT_Test_API() - call fail cmd=["
...
.method public LGE_WIFI_RFT_Test_API_response()Ljava/lang/String;
    .locals 1

    .prologue
    .line 2097
    iget-object v0, p0, Lcom/android/server/NetworkManagementService;->returnValue:Ljava/lang/String;
...
.method public acceptPacket(Ljava/lang/String;)V
    ...
    const-string v4, "nat accept %s null 0"
...
.method public enableNat(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1130
    .local v0, PortForwardingStatus:I
    const-string v2, "NetworkManagementService"
    ...
    const-string v4, "PortForwardingStatus = "
    ...
    const-string v3, "Start CMD for LTE Port Forwarding"

    invoke-static {v2, v3}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1135
    invoke-virtual {p0}, Lcom/android/server/NetworkManagementService;->startPortForwarding()V
    ...
    .line 1122
    .end local v0           #PortForwardingStatus:I
    :catch_0
    move-exception v1
    ...
    const-string v3, "Unable to communicate to native daemon for enabling NAT interface"
...
.method public runClearNatRule()V
    ...
    const-string v1, "[antonio] runClearNatRule"
    ...
    const-string v1, "[antonio]call docommand runClearNatRule "
    ...
    const-string v1, "nat clearNatRule 0 0 0"
...
.method public runClearPortFilterRule()V
    ...
    const-string v1, "[antonio] runClearPortFilterRule"
    ...
    const-string v1, "[antonio]call docommand clearPortFilterRule "
    ...
    const-string v1, "nat clearPortFilterRule 0 0 0"
...
.method public runClearPortForwardRule()V
    ...
    const-string v1, "[antonio] runClearPortForwardRule"
    ...
    const-string v1, "[antonio]call docommand runClearPortForwardRule "
    ...
    const-string v1, "nat clearPortForwardRule 0 0 0"
...
.method public runSetNatForwardRule(Ljava/lang/String;)V
    ...
    const-string v1, "[antonio]call docommand setNatForwardRule %s "
    ...
    const-string v1, "nat setNatForwardRule %s 0 0"
...
.method public runSetPortFilterRule(Ljava/lang/String;I)V
    ...
    const-string v1, "[antonio] runSetPortFilterRule"
    ...
    const-string v1, "[antonio]call docommand runSetPortFilterRule "
    ...
    const-string v1, "nat setPortFilterRule %s %d"
...
.method public runSetPortForwardRule(Ljava/lang/String;I)V
    ...
    const-string v1, "[antonio] runSetPortForwardRule"
    ...
    const-string v1, "[antonio]call docommand runSetPortForwardRule "
    ...
    const-string v1, "nat setPortForwardRule %s %d"
...
.method public setAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v2, p1, v5, v5}, Lcom/lge/wifi_iface/WifiSapIfaceIface;->setSoftApWifiCfg(Landroid/net/wifi/WifiConfiguration;II)Z
    ...
    const-string v3, "wifi_ap_current_max_client"
    ...
    const-string v3, "wifi_ssid_visibility"
...
.method public startAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v2, v6, p1, v5, v5}, Lcom/lge/wifi_iface/WifiSapIfaceIface;->setNstartMonitoring(ZLandroid/net/wifi/WifiConfiguration;II)Z
    ...
    const-string v4, "startAccessPoint wifiFirmwareReload "
    ...
    const-string v3, "startAccessPoint softap start"
    ...
    invoke-interface {v2, v3, v4, v5, v6}, Lcom/lge/wifi_iface/WifiSapIfaceIface;->setNstartMonitoring(ZLandroid/net/wifi/WifiConfiguration;II)Z
...
.method public declared-synchronized startPortForwarding()V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;
    ...
    const-string v2, "startPortForwarding Func starts!! : startPortForwarding"
    ...
    const-string v2, "ipfwd portforwarding"
    ...
    const-string v2, "Unable to communicate to native daemon for ipfwd portforwarding"
...
.method public startVZWAccessPoint(Landroid/net/wifi/WifiVZWConfiguration;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v8, "startAccessPoint wifiFirmwareReload "
    ...
    const-string v8, "startAccessPoint softap start "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p1, Landroid/net/wifi/WifiVZWConfiguration;->SSID:Ljava/lang/String;
    ...
    const-string v7, "startAccessPoint softap set  wificonfig == null"
    ...
    const-string v7, "softap startap"
    ...
    invoke-interface {v6, v7, v8, v9, v10}, Lcom/lge/wifi_iface/WifiSapIfaceIface;->setVZWNstartMonitoring(ZLandroid/net/wifi/WifiVZWConfiguration;II)Z
    ...
    .line 2342
    :cond_0
    iget-boolean v6, p1, Landroid/net/wifi/WifiVZWConfiguration;->hiddenSSID:Z
    ...
    .line 2348
    .local v3, secureVZW:Ljava/lang/String;
    iget-object v6, p1, Landroid/net/wifi/WifiVZWConfiguration;->preSharedKey:Ljava/lang/String;
    ...
    .line 2351
    :cond_1
    iget-object v6, p1, Landroid/net/wifi/WifiVZWConfiguration;->wepKeys:[Ljava/lang/String;

    iget v7, p1, Landroid/net/wifi/WifiVZWConfiguration;->wepTxKeyIndex:I
    ...
    const-string v7, " %s %s %s %s %s %s %s %s %s %s %s "
    ...
    iget-object v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->SSID:Ljava/lang/String;
    ...
    iget v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->Channel:I
    ...
    iget v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->Maxscb:I
    ...
    iget-object v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->hw_mode:Ljava/lang/String;
    ...
    iget-object v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->CountryCode:Ljava/lang/String;
    ...
    iget v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->ap_isolate:I
    ...
    iget v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->ieee_mode:I
    ...
    invoke-virtual {v6, v4}, Lcom/android/server/NativeDaemonConnector;->doCommand(Ljava/lang/String;)Ljava/util/ArrayList;

    .line 2376
    const-string v6, "softap set2 %s %s %s "
    ...
    iget v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->macaddr_acl:I
    ...
    iget-object v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->accept_mac_file:Ljava/lang/String;
    ...
    iget-object v9, p1, Landroid/net/wifi/WifiVZWConfiguration;->deny_mac_file:Ljava/lang/String;
    ...
    .end local v3           #secureVZW:Ljava/lang/String;
    ...
    const-string v7, "Error communicating to native daemon to start softap"
    ...
    .line 2355
    .restart local v2       #secureKey:Ljava/lang/String;
    .restart local v3       #secureVZW:Ljava/lang/String;
    :cond_3
    :try_start_1
    iget-object v6, p1, Landroid/net/wifi/WifiVZWConfiguration;->preSharedKey:Ljava/lang/String;
...
.method public stopAccessPoint(Ljava/lang/String;)V
    ...
    invoke-interface {v1, v5, v6, v4, v4}, Lcom/lge/wifi_iface/WifiSapIfaceIface;->setNstartMonitoring(ZLandroid/net/wifi/WifiConfiguration;II)Z
...
.method public stopVZWAccessPoint(Ljava/lang/String;)V
    ...
    invoke-interface {v1, v2, v3, v4, v4}, Lcom/lge/wifi_iface/WifiSapIfaceIface;->setVZWNstartMonitoring(ZLandroid/net/wifi/WifiVZWConfiguration;II)Z
