...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/LocationManagerService$IndicatorLocationHandler;,
...
.field private static final MESSAGE_LOCATION_DISABLE:I = 0x2

.field private static final MESSAGE_LOCATION_ENABLE:I = 0x1
...
.field private static mFlightModeGpsStatus:Z
...
.field private mIndicatorHandler:Landroid/os/Handler;
...
.method static constructor <clinit>()V
    ...
    .line 222
    sput-boolean v0, Lcom/android/server/LocationManagerService;->mFlightModeGpsStatus:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/LocationManagerService;->mVendor:Ljava/lang/String;

    .line 118
    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/android/server/LocationManagerService;->mSKTTmapStarted:Z

    .line 119
    iput-boolean v2, p0, Lcom/android/server/LocationManagerService;->mGPSSettingEnabled:Z
    ...
    .line 171
    iput-object v3, p0, Lcom/android/server/LocationManagerService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method static synthetic access$2700(Lcom/android/server/LocationManagerService;)Ljava/lang/String;
    ...
    .prologue
    .line 111
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mVendor:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$2800(Lcom/android/server/LocationManagerService;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 111
    iget-boolean v0, p0, Lcom/android/server/LocationManagerService;->mSKTTmapStarted:Z

    return v0
.end method

.method static synthetic access$2802(Lcom/android/server/LocationManagerService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 111
    iput-boolean p1, p0, Lcom/android/server/LocationManagerService;->mSKTTmapStarted:Z

    return p1
.end method

.method static synthetic access$2900(Lcom/android/server/LocationManagerService;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 111
    iget-boolean v0, p0, Lcom/android/server/LocationManagerService;->mGPSSettingEnabled:Z

    return v0
.end method

.method static synthetic access$2902(Lcom/android/server/LocationManagerService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 111
    iput-boolean p1, p0, Lcom/android/server/LocationManagerService;->mGPSSettingEnabled:Z
...
.method static synthetic access$3000(Lcom/android/server/LocationManagerService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"

    .prologue
    .line 111
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mIndicatorHandler:Landroid/os/Handler;
...
.method static synthetic access$3100()Z
    ...
    .prologue
    .line 111
    sget-boolean v0, Lcom/android/server/LocationManagerService;->mFlightModeGpsStatus:Z
...
.method static synthetic access$3102(Z)Z
    ...
    .prologue
    .line 111
    sput-boolean p0, Lcom/android/server/LocationManagerService;->mFlightModeGpsStatus:Z
...
.method private initialize()V
    ...
    invoke-virtual {v14, v3, v4}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v3

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/server/LocationManagerService;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    .line 601
    invoke-direct/range {p0 .. p0}, Lcom/android/server/LocationManagerService;->loadProviders()V
    ...
    .line 613
    .local v13, mProperties:Ljava/util/Properties;
    :try_start_0
    ...
    invoke-virtual {v13, v0}, Ljava/util/Properties;->load(Ljava/io/InputStream;)V
    ...
    invoke-virtual {v13, v3}, Ljava/util/Properties;->getProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v8, v0, Lcom/android/server/LocationManagerService;->mVendor:Ljava/lang/String;
    :try_end_0
    ...
    iget-object v3, v0, Lcom/android/server/LocationManagerService;->mVendor:Ljava/lang/String;
    ...
    .line 638
    :cond_2
    new-instance v3, Lcom/android/server/LocationManagerService$IndicatorLocationHandler;

    const/4 v4, 0x0

    move-object/from16 v0, p0

    invoke-direct {v3, v0, v4}, Lcom/android/server/LocationManagerService$IndicatorLocationHandler;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/server/LocationManagerService;->mIndicatorHandler:Landroid/os/Handler;
    ...
    iget-object v4, v0, Lcom/android/server/LocationManagerService;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v3, v4, v12}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    iget-object v4, v0, Lcom/android/server/LocationManagerService;->mBatteryBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string v5, "(name=?) or (name=?) or (name=?) "
    ...
    new-instance v3, Landroid/content/ContentQueryMap;
    ...
    invoke-direct {v3, v0, v4, v5, v6}, Landroid/content/ContentQueryMap;-><init>(Landroid/database/Cursor;Ljava/lang/String;ZLandroid/os/Handler;)V

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/server/LocationManagerService;->mSettings:Landroid/content/ContentQueryMap;

    .line 661
    new-instance v17, Lcom/android/server/LocationManagerService$SettingsObserver;
    ...
    invoke-direct {v0, v1, v3}, Lcom/android/server/LocationManagerService$SettingsObserver;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V

    .line 662
    .local v17, settingsObserver:Lcom/android/server/LocationManagerService$SettingsObserver;
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/LocationManagerService;->mSettings:Landroid/content/ContentQueryMap;

    move-object/from16 v0, v17

    invoke-virtual {v3, v0}, Landroid/content/ContentQueryMap;->addObserver(Ljava/util/Observer;)V
    ...
    .end local v9           #batteryFilter:Landroid/content/IntentFilter;
    .end local v15           #sdFilter:Landroid/content/IntentFilter;
    .end local v16           #settingsCursor:Landroid/database/Cursor;
    .end local v17           #settingsObserver:Lcom/android/server/LocationManagerService$SettingsObserver;
    :catch_0
    move-exception v10
    ...
    const-string v4, "Could not open GPS configuration file /etc/gps.conf"
...
.method public removeTestProvider(Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/android/server/LocationManagerService;->mHybridLocationProvider:Lcom/android/server/location/LocationProviderInterface;
