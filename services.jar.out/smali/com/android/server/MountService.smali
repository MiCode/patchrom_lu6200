...
.field private static final ECRYPTFS_TAG:Ljava/lang/String; = "MOBII"

.field private static final EXT_MOUNT_PATH:Ljava/lang/String; = "/mnt/sdcard"
...
.field passwordHandler:Landroid/os/Handler;

.field syncHandler:Landroid/os/Handler;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 133
    iput-boolean v7, p0, Lcom/android/server/MountService;->isSDcardEncryption:Z
    ...
    iput-object v3, p0, Lcom/android/server/MountService;->passwordHandler:Landroid/os/Handler;
    ...
    iput-object v3, p0, Lcom/android/server/MountService;->syncHandler:Landroid/os/Handler;
    ...
    .line 541
    new-instance v3, Lcom/android/server/MountService$3;

    invoke-direct {v3, p0}, Lcom/android/server/MountService$3;-><init>(Lcom/android/server/MountService;)V
    ...
    iput-object v3, p0, Lcom/android/server/MountService;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iput-boolean v3, p0, Lcom/android/server/MountService;->isSDcardEncryption:Z
...
.method static synthetic access$000(Lcom/android/server/MountService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$100(Lcom/android/server/MountService;)Lcom/android/server/MountService$ObbActionHandler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1600(Lcom/android/server/MountService;Landroid/content/res/Resources;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1900(Lcom/android/server/MountService;)Z
    ...
    .prologue
    .line 111
    iget-boolean v0, p0, Lcom/android/server/MountService;->isSDcardEncryption:Z
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    invoke-interface {v13, v14, v15, v0}, Lcom/lge/cappuccino/IMdm;->checkDisabledMountService(Landroid/content/ComponentName;Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string v14, "volume mount %s"
    ...
    .line 970
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/MountService;->showSyncPopup()V
    :try_end_0
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 978
    .local v3, code:I
    const-string v13, "MOBII"

    new-instance v14, Ljava/lang/StringBuilder;

    invoke-direct {v14}, Ljava/lang/StringBuilder;-><init>()V

    const-string v15, "doMountVolume: error code = "
    ...
    iget-boolean v13, v0, Lcom/android/server/MountService;->isSDcardEncryption:Z
    ...
    invoke-direct {v0, v2, v1}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v14, "updating volume state media SDCryptEncryptionNeeded"
    ...
    iget-object v13, v0, Lcom/android/server/MountService;->passwordHandler:Landroid/os/Handler;
    ...
    .line 1019
    .local v9, mount_successful:I
    :try_start_1
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/MountService;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-virtual {v13}, Lcom/android/internal/widget/LockPatternUtils;->getPasswordHash()Ljava/lang/String;

    move-result-object v11

    .line 1022
    .local v11, password_hash:Ljava/lang/String;
    if-eqz v11, :cond_7
    ...
    invoke-virtual {v13}, Lcom/android/internal/widget/LockPatternUtils;->isLockPatternEnabled()Z
    ...
    .line 1024
    :cond_7
    const-string v13, "persist.sdcrypto.enabled"
    ...
    const-string v14, "doMountVolume: password set dialog OK "
    ...
    const-string v14, "doMountVolume: HERE OK!! "
    ...
    .line 1039
    .local v4, cut_password_hash:Ljava/lang/String;
    if-eqz v11, :cond_9
    ...
    const-string v15, "doMountVolume: cut_password_hash = "
    ...
    const-string v14, "do sdcryptfs mount!! "
    ...
    const-string v14, "sdcryptfs mount %s %s"
    ...
    .line 1108
    .end local v4           #cut_password_hash:Ljava/lang/String;
    .end local v11           #password_hash:Ljava/lang/String;
    :cond_a
    :goto_3
    const/4 v13, 0x1
    ...
    const-string v14, "Send sdcryptfs complete"
    ...
    const-string v14, "sdcryptfs complete %s"
    ...
    .line 1114
    .local v7, exxx:Ljava/lang/Exception;
    const-string v13, "MountService"

    const-string v14, "sdcryptfs complete error"
    ...
    .line 1051
    .end local v7           #exxx:Ljava/lang/Exception;
    :catch_2
    move-exception v6

    .line 1052
    .local v6, ex:Lcom/android/server/NativeDaemonConnectorException;
    ...
    const-string v14, "updating volume state media SDCryptReadAuthFail"
    ...
    const-string v14, "updating volume state media SDCryptDeviceAuthFail"
    ...
    .line 1091
    invoke-virtual {v5}, Lcom/android/server/NativeDaemonConnectorException;->getCmd()Ljava/lang/String;

    move-result-object v8

    .line 1092
    .local v8, media_password_hash:Ljava/lang/String;
    const-string v13, "MountService"
    ...
    const-string v15, "updating volume state media SDCryptPasswordAuthFail phone_pass="
    ...
    .line 1093
    .end local v8           #media_password_hash:Ljava/lang/String;
    .end local v10           #msg:Landroid/os/Message;
    :cond_d
    const/16 v13, 0x19d
    ...
    const-string v14, "updating volume state media SDCryptPasswordNull"
    ...
    .line 1120
    .end local v6           #ex:Lcom/android/server/NativeDaemonConnectorException;
    .end local v9           #mount_successful:I
    .end local v10           #msg:Landroid/os/Message;
    :cond_e
    const/4 v12, -0x1
...
.method public MDMStorageEncryptionStatus()Z
    ...
    .line 2416
    .local v2, ret:Z
    invoke-virtual {p0}, Lcom/android/server/MountService;->getInternalSDCardMountPath()Ljava/lang/String;

    move-result-object v1

    .line 2417
    invoke-virtual {p0}, Lcom/android/server/MountService;->getExternalSDCardMountPath()Ljava/lang/String;
    ...
    .line 2421
    const-string v3, "persist.insdcrypto.enabled"
...
.method public StorageDisableEncryption()I
    .locals 12
    ...
    invoke-virtual {p0}, Lcom/android/server/MountService;->getCutPasswordHash()Ljava/lang/String;
    ...
    const-string v7, "sdcryptfs disablecrypto %s"
    ...
    const-string v8, "StorageDisableEncryption inPath ret"
    ...
    const-string v8, "StorageDisableEncryption OutPath ret"
...
.method public StorageEnableEncryption()I
    .locals 13
    ...
    const-string v7, "sdcryptfs enablecrypto %s %s %s"
    ...
    invoke-virtual {p0}, Lcom/android/server/MountService;->getPassType()Ljava/lang/String;
    ...
    const-string v8, "StorageEnableEncryption InPath ret = "
    ...
    const-string v8, "StorageEnableEncryption OutPath ret = "
...
.method public externalSDCardChangeEncryptionPassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    .locals 11
    .parameter "path"
    .parameter "password"
    .parameter "pass_type"
    ...
    const-string v8, "InternalSDCard= "
    ...
    const-string v8, " External SDCard="
    ...
    const-string v7, "sdcryptfs changepw %s %s %s"
    ...
    const-string v8, "externalSDCardChangeEncryptionPassword intPath ret"
    ...
    const-string v8, "externalSDCardChangeEncryptionPassword extPath ret"
    ...
    const-string v7, "externalSDCardChangeEncryptionPassword. Wrong path name"
...
.method public externalSDCardCheckEncryption(Ljava/lang/String;)I
    .locals 11
    .parameter "path"
    ...
    const-string v7, "sdcryptfs checkcrypto %s"
    ...
    const-string v8, "externalSDCardCheckEncryption intPath ret"
    ...
    const-string v8, "externalSDCardCheckEncryption extPath ret"
    ...
    const-string v7, "externalSDCardCheckEncryption. Wrong path name"
...
.method public externalSDCardDisableEncryption(Ljava/lang/String;)I
    ...
    const-string v8, "externalSDCardDisableEncryption intPath ret"
    ...
    const-string v8, "externalSDCardDisableEncryption extPath ret"
    ...
    const-string v7, "externalSDCardEnableEncryption. Wrong path name"
...
.method public externalSDCardEnableEncryption(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    .locals 11
    .parameter "path"
    .parameter "password"
    .parameter "pass_type"
    ...
    const-string v8, "externalSDCardEnableEncryption intPath ret"
    ...
    const-string v8, "externalSDCardEnableEncryption extPath ret"
...
.method public externalSDCardGetPasswordType(Ljava/lang/String;)Ljava/lang/String;
    .locals 12
    .parameter "path"
    ...
    .line 2924
    .local v3, intPath:Ljava/lang/String;
    const/4 v2, 0x0
    ...
    const-string v8, "android.permission.CRYPT_KEEPER"

    const-string v9, "no permission to access the crypt keeper"
    ...
    .line 2936
    const-string v7, "internalStorage"
    ...
    const-string v8, "sdcryptfs getpwtype %s"
    ...
    .line 2954
    .local v4, response:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    const/4 v7, 0x0
    ...
    .line 2962
    .end local v0           #code:I
    .end local v4           #response:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    const-string v8, "externalSDCardGetPasswordType. Wrong path name"
    ...
    .line 2960
    .restart local v0       #code:I
    .restart local v4       #response:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
...
.method public externalSDCardMountComplete(Ljava/lang/String;)I
    ...
    const-string v7, "sdcryptfs complete %s"
    ...
    const-string v8, "externalSDCardMountComplete intPath ret"
    ...
    const-string v8, "externalSDCardMountComplete extPath ret"
    ...
    .line 2917
    :cond_5
    invoke-virtual {p0}, Lcom/android/server/MountService;->showSyncPopup()V
    ...
    const-string v7, "externalSDCardMountComplete. Wrong path name"
...
.method public externalSDCardMountEncryption(Ljava/lang/String;Ljava/lang/String;)I
    .locals 11
    .parameter "path"
    ...
    const-string v7, "sdcryptfs mount %s %s"
    ...
    const-string v8, "externalSDCardMountEncryption intPath ret"
    ...
    const-string v8, "externalSDCardMountEncryption extPath ret"
...
.method public externalSDCardUnmountEncryption(Ljava/lang/String;)I
    .locals 11
    .parameter "path"
    ...
    const-string v7, "sdcryptfs unmount %s"
    ...
    const-string v8, "externalSDCardUnmountEncryption intPath ret"
    ...
    const-string v8, "externalSDCardUnmountEncryption extPath ret"
    ...
    const-string v7, "externalSDCardUnmountEncryption. Wrong path name"
...
.method public externalSDCardVerifyEncryptionPassword(Ljava/lang/String;Ljava/lang/String;)I
    .locals 11
    .parameter "path"
    .parameter "password"
    ...
    const-string v7, "sdcryptfs verifypw %s %s"
    ...
    const-string v8, "externalSDCardVerifyEncryptionPassword intPath ret"
    ...
    const-string v8, "externalSDCardVerifyEncryptionPassword extPath ret"
    ...
    const-string v7, "externalSDCardVerifyEncryptionPassword. Wrong path name"
...
.method public getCutPasswordHash()Ljava/lang/String;
    .locals 3
    ...
    invoke-virtual {v1}, Lcom/android/internal/widget/LockPatternUtils;->getPasswordHash()Ljava/lang/String;
...
.method public getExternalSDCardMountPath()Ljava/lang/String;
    ...
    .line 2184
    .end local v2           #mStorageVolume:Landroid/os/storage/StorageVolume;
    :goto_1
    return-object v3

    .line 2178
    .restart local v2       #mStorageVolume:Landroid/os/storage/StorageVolume;
    :cond_0
    add-int/lit8 v0, v0, 0x1
...
.method public getPassType()Ljava/lang/String;
    ...
    .prologue
    .line 2263
    iget-object v3, p0, Lcom/android/server/MountService;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    .line 2268
    .local v1, pass_type:Ljava/lang/String;
    :goto_1
    return-object v1

    .line 2264
    .end local v0           #isAlpha:Z
    .end local v1           #pass_type:Ljava/lang/String;
    :cond_1
    const/4 v0, 0x0
...
.method public isGBEncryptionMount(Ljava/lang/String;)Z
    .locals 11
    .parameter "path"
    ...
    const-string v9, "isGBEncryptionMount"
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-direct {v8, p0, v7}, Lcom/android/server/MountService$5;-><init>(Lcom/android/server/MountService;Ljava/lang/String;)V
...
.method public showSyncPopup()V
    .locals 6

    .prologue
    .line 3692
    const-string v3, "/mnt/sdcard/LGEmail_enc"

    invoke-virtual {p0, v3}, Lcom/android/server/MountService;->isGBEncryptionMount(Ljava/lang/String;)Z
    ...
    const-string v5, "isGBEncryptionMount"
    ...
    const-string v3, "/mnt/sdcard/encryption/LGEmail_enc.img"
    ...
    .line 3698
    iget-object v3, p0, Lcom/android/server/MountService;->syncHandler:Landroid/os/Handler;
