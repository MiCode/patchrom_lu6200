...
# instance fields
.field private HDMIListener:Landroid/content/BroadcastReceiver;
...
.field private mHdmiService:Landroid/os/IHDMIService;
...
.field private suspendIntent:Ljava/lang/String;

.field private suspendIntentListener:Landroid/content/BroadcastReceiver;

.field private suspendPackageName:Ljava/lang/String;

.field private suspendPermission:Ljava/lang/String;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Z)V
    ...
    .line 127
    iput-object v3, p0, Lcom/android/server/am/ActivityStack;->mWiFiOffloadingIfaceIface:Lcom/lge/wifi_iface/WiFiOffloadingIfaceIface;
    ...
    .line 334
    iput-object v3, p0, Lcom/android/server/am/ActivityStack;->mToast:Landroid/widget/Toast;

    .line 338
    iput-object v3, p0, Lcom/android/server/am/ActivityStack;->mHdmiService:Landroid/os/IHDMIService;

    .line 339
    iput-object v3, p0, Lcom/android/server/am/ActivityStack;->mAudioService:Landroid/media/IAudioService;

    .line 340
    iput-boolean v4, p0, Lcom/android/server/am/ActivityStack;->mHDMISuspended:Z

    .line 341
    iput-boolean v4, p0, Lcom/android/server/am/ActivityStack;->mHDMIConnected:Z

    .line 343
    const-string v1, "android.permission.HDMI_SUSPEND"

    iput-object v1, p0, Lcom/android/server/am/ActivityStack;->suspendPermission:Ljava/lang/String;

    .line 344
    const-string v1, "jp.pixela.StationMobile"

    iput-object v1, p0, Lcom/android/server/am/ActivityStack;->suspendPackageName:Ljava/lang/String;

    .line 345
    const-string v1, "intent.extra.externalvideo.DISABLE_HDMI"

    iput-object v1, p0, Lcom/android/server/am/ActivityStack;->suspendIntent:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/server/am/ActivityStack;->HDMIListener:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, Lcom/android/server/am/ActivityStack;->suspendIntentListener:Landroid/content/BroadcastReceiver;
    ...
    .line 512
    new-instance v1, Lcom/android/server/am/ActivityStack$4;

    invoke-direct {v1, p0}, Lcom/android/server/am/ActivityStack$4;-><init>(Lcom/android/server/am/ActivityStack;)V
...
.method static synthetic access$002(Lcom/android/server/am/ActivityStack;Z)Z
    ...
    .prologue
    .line 108
    iput-boolean p1, p0, Lcom/android/server/am/ActivityStack;->mHDMIConnected:Z

    return p1
.end method

.method static synthetic access$100(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityRecord;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 108
    invoke-direct {p0, p1}, Lcom/android/server/am/ActivityStack;->suspendHDMILocked(Lcom/android/server/am/ActivityRecord;)V

    return-void
.end method

.method static synthetic access$200(Lcom/android/server/am/ActivityStack;)Ljava/lang/String;
    .locals 1
    .parameter "x0"

    .prologue
    .line 108
    iget-object v0, p0, Lcom/android/server/am/ActivityStack;->suspendIntent:Ljava/lang/String;

    return-object v0
.end method

.method private checkHDMISuspendedActivity(Lcom/android/server/am/ActivityRecord;)V
    .locals 3
    .parameter "hr"
    ...
    const-string v2, "checkHDMISuspendedActivity() "
    ...
    .line 4646
    invoke-direct {p0, p1}, Lcom/android/server/am/ActivityStack;->checkSuspendPermission(Lcom/android/server/am/ActivityRecord;)I

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, Lcom/android/server/am/ActivityStack;->checkSuspendPackageName(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/am/ActivityRecord;->setSuspendHDMI(Z)V
...
.method private checkSuspendPackageName(Lcom/android/server/am/ActivityRecord;)Z
    .locals 2
    .parameter "hr"
    ...
    iget-object v1, p0, Lcom/android/server/am/ActivityStack;->suspendPackageName:Ljava/lang/String;
...
.method private checkSuspendPermission(Lcom/android/server/am/ActivityRecord;)I
    .locals 4
    .parameter "hr"
    ...
    .line 4658
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->suspendPermission:Ljava/lang/String;
...
.method private copyIntentExtra(Landroid/content/Intent;Landroid/content/Intent;)V
    .locals 2
    .parameter "srcIntent"
    .parameter "dstIntent"
    ...
    .line 4589
    :cond_1
    iget-object v0, p1, Landroid/content/Intent;->mReal3DProfile:Landroid/opengl/EGLReal3DProfile;
    ...
    iput-object v0, p2, Landroid/content/Intent;->mReal3DProfile:Landroid/opengl/EGLReal3DProfile;
    ...
    iget-object v1, p1, Landroid/content/Intent;->mReal3DProfile:Landroid/opengl/EGLReal3DProfile;

    invoke-direct {v0, v1}, Landroid/opengl/EGLReal3DProfile;-><init>(Landroid/opengl/EGLReal3DProfile;)V
...
.method private findSameTasks(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)Ljava/util/List;
    .locals 8
    .parameter "intent"
    .parameter "info"
    .annotation system Ldalvik/annotation/Signature;
    ...
    .line 4606
    .local v5, retList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/ActivityRecord;>;"
...
.method private getAudioService()Landroid/media/IAudioService;
    ...
    .prologue
    .line 4637
    iget-object v0, p0, Lcom/android/server/am/ActivityStack;->mAudioService:Landroid/media/IAudioService;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mAudioService:Landroid/media/IAudioService;
...
.method private getHdmiService()Landroid/os/IHDMIService;
    .locals 1

    .prologue
    .line 4630
    iget-object v0, p0, Lcom/android/server/am/ActivityStack;->mHdmiService:Landroid/os/IHDMIService;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mHdmiService:Landroid/os/IHDMIService;
...
.method private notifyAllowHdmiMirroring()V
    .locals 4

    .prologue
    .line 4729
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->getHdmiService()Landroid/os/IHDMIService;

    move-result-object v1

    .line 4730
    .local v1, hdmiService:Landroid/os/IHDMIService;
    if-eqz v1, :cond_0

    .line 4731
    const/4 v2, 0x0

    invoke-interface {v1, v2}, Landroid/os/IHDMIService;->setHDMISuspendParam(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .line 4736
    .end local v1           #hdmiService:Landroid/os/IHDMIService;
    :cond_0
    :goto_0
    return-void
    ...
    const-string v3, "HDMIService is dead?!?"
...
.method private notifySuspendHdmiMirroring()V
    .locals 5
    ...
    const-string v4, "HDMIService is dead?!?"
...
.method private sendSuspendStatetoAudioLocked(Z)V
    .locals 4
    .parameter "state"
    ...
    .line 4676
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->getAudioService()Landroid/media/IAudioService;
    ...
    .line 4678
    invoke-interface {v0, p1}, Landroid/media/IAudioService;->setHDMISuspend(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "AudioService is dead?!?"
...
.method private final startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZZ)V
    ...
    .line 1782
    .local v10, p:Lcom/android/server/am/ActivityRecord;
    iget-boolean v1, v10, Lcom/android/server/am/ActivityRecord;->finishing:Z
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/android/server/wm/WindowManagerService;->addAppToken(ILandroid/view/IApplicationToken;IIZ)V

    .line 1913
    .end local v9           #i:I
    .end local v10           #p:Lcom/android/server/am/ActivityRecord;
    ...
    .restart local v10       #p:Lcom/android/server/am/ActivityRecord;
    .restart local v13       #startIt:Z
    :cond_3
    iget-boolean v1, v10, Lcom/android/server/am/ActivityRecord;->fullscreen:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/am/ActivityStack;->mUserLeaving:Z
    ...
    iget-object v1, v1, Lcom/android/server/am/ActivityManagerService;->mProcessNames:Lcom/android/server/ProcessMap;
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/server/ProcessMap;->get(Ljava/lang/String;I)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3, v0}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
    ...
    .line 1876
    invoke-direct {p0, p1, p1}, Lcom/android/server/am/ActivityStack;->resetTaskIfNeededLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    .line 1910
    .end local v8           #doShow:Z
    .end local v11           #proc:Lcom/android/server/am/ProcessRecord;
    .end local v12           #showStartingIcon:Z
    :cond_a
    :goto_4
    if-eqz p3, :cond_2
    ...
    .line 1855
    .restart local v11       #proc:Lcom/android/server/am/ProcessRecord;
    .restart local v12       #showStartingIcon:Z
    :cond_b
    iget-object v1, p1, Lcom/android/server/am/ActivityRecord;->intent:Landroid/content/Intent;
    ...
    invoke-virtual {v3, v1, v0}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
...
.method private suspendHDMILocked(Lcom/android/server/am/ActivityRecord;)V
    .locals 3
    .parameter "hr"
    ...
    .line 4687
    :try_start_0
    iget-boolean v0, p0, Lcom/android/server/am/ActivityStack;->mHDMIConnected:Z
    ...
    .line 4693
    invoke-virtual {p1}, Lcom/android/server/am/ActivityRecord;->getSuspendHDMI()Z
    ...
    .line 4694
    iget-boolean v0, p0, Lcom/android/server/am/ActivityStack;->mHDMISuspended:Z
    ...
    const-string v2, "checkHdmiSuspendLocked() >> notifySuspendHdmiMirroring"

    invoke-static {v0, v2}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 4697
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->notifySuspendHdmiMirroring()V

    .line 4698
    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lcom/android/server/am/ActivityStack;->sendSuspendStatetoAudioLocked(Z)V

    .line 4699
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/am/ActivityStack;->mHDMISuspended:Z
    ...
    const-string v2, "checkHdmiSuspendLocked() >> notifyAllowHdmiMirroring"

    invoke-static {v0, v2}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 4705
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->notifyAllowHdmiMirroring()V
...
.method public getTaskAccessInfoLocked(IZ)Lcom/android/server/am/TaskAccessInfo;
    ...
    .line 4397
    new-instance v9, Lcom/android/server/am/ActivityStack$5;

    invoke-direct {v9, p0, v8}, Lcom/android/server/am/ActivityStack$5;-><init>(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/TaskAccessInfo;)V
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-interface {v5, v8, v6, v7}, Lcom/lge/cappuccino/IMdm;->checkMoveTaskToFrontLocked(Landroid/content/ComponentName;Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-interface {v5, v8, v6}, Lcom/lge/cappuccino/IMdm;->isMessageApp(Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    invoke-interface {v5, v6}, Lcom/lge/cappuccino/IMdm;->checkUnsignedApplicationEnable(Ljava/lang/String;)Z
    ...
    invoke-interface {v5, v6}, Lcom/lge/cappuccino/IMdm;->checkApplicationEnable(Ljava/lang/String;)Z
    ...
    invoke-interface {v5, v8}, Lcom/lge/cappuccino/IMdm;->getAllowScreenCapture(Landroid/content/ComponentName;)Z
    ...
    const-string v6, "LGMDM Block ScreenCapture"
    ...
    invoke-interface {v5, v10}, Lcom/lge/cappuccino/IMdm;->sendToastMessageId(I)V
    ...
    invoke-interface {v5, v8}, Lcom/lge/cappuccino/IMdm;->checkAllowScreenCaptureWithBlacklist(Landroid/content/ComponentName;)Z
    ...
    const-string v6, "LGMDM Block ScreenCapture by blacklist"
    ...
    invoke-virtual {v5, v9, v9}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
    ...
    invoke-virtual {v5, v6, v9}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    .line 702
    invoke-direct/range {p0 .. p1}, Lcom/android/server/am/ActivityStack;->checkHDMISuspendedActivity(Lcom/android/server/am/ActivityRecord;)V
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    iget-boolean v9, p0, Lcom/android/server/am/ActivityStack;->mUserLeaving:Z

    .line 1440
    .local v9, userLeaving:Z
    const/4 v10, 0x0

    iput-boolean v10, p0, Lcom/android/server/am/ActivityStack;->mUserLeaving:Z
    ...
    iput-boolean v10, v6, Lcom/android/server/am/ActivityRecord;->delayedResume:Z
    ...
    invoke-virtual {v10}, Lcom/android/server/wm/WindowManagerService;->executeAppTransition()V
    ...
    iget-boolean v10, v10, Lcom/android/server/am/ActivityManagerService;->mSleeping:Z
    ...
    :cond_2
    iget-object v10, p0, Lcom/android/server/am/ActivityStack;->mLastPausedActivity:Lcom/android/server/am/ActivityRecord;
    ...
    sget-object v11, Lcom/android/server/am/ActivityStack$ActivityState;->STOPPED:Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    .line 1475
    :cond_4
    iget-object v10, p0, Lcom/android/server/am/ActivityStack;->mStoppingActivities:Ljava/util/ArrayList;

    invoke-virtual {v10, v6}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    .line 1476
    iget-object v10, p0, Lcom/android/server/am/ActivityStack;->mGoingToSleepActivities:Ljava/util/ArrayList;
    ...
    .line 1478
    iget-object v10, p0, Lcom/android/server/am/ActivityStack;->mWaitingVisibleActivities:Ljava/util/ArrayList;
    ...
    invoke-virtual {v10, v11}, Lcom/android/internal/app/ActivityTrigger;->activityResumeTrigger(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/server/am/ActivityStack;->startPausingLocked(ZZ)V
    ...
    .line 1529
    iget-boolean v10, p1, Lcom/android/server/am/ActivityRecord;->waitingVisible:Z

    if-nez v10, :cond_e

    if-eqz v6, :cond_e

    iget-boolean v10, v6, Lcom/android/server/am/ActivityRecord;->nowVisible:Z
    ...
    iput-boolean v10, p1, Lcom/android/server/am/ActivityRecord;->waitingVisible:Z
    ...
    invoke-interface {v10, v11, v12}, Landroid/content/pm/IPackageManager;->setPackageStoppedState(Ljava/lang/String;Z)V
    :try_end_0
    ...
    invoke-virtual {v10, v11}, Lcom/android/server/wm/WindowManagerService;->setAppWillBeHidden(Landroid/os/IBinder;)V
    ...
    .line 1621
    invoke-virtual {v6}, Lcom/android/server/am/ActivityRecord;->startLaunchTickingLocked()V

    .line 1623
    iget-object v4, p0, Lcom/android/server/am/ActivityStack;->mResumedActivity:Lcom/android/server/am/ActivityRecord;

    .line 1624
    .local v4, lastResumedActivity:Lcom/android/server/am/ActivityRecord;
    iget-object v5, v6, Lcom/android/server/am/ActivityRecord;->state:Lcom/android/server/am/ActivityStack$ActivityState;

    .line 1626
    .local v5, lastState:Lcom/android/server/am/ActivityStack$ActivityState;
    iget-object v10, p0, Lcom/android/server/am/ActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;

    invoke-virtual {v10}, Lcom/android/server/am/ActivityManagerService;->updateCpuStats()V

    .line 1629
    sget-object v10, Lcom/android/server/am/ActivityStack$ActivityState;->RESUMED:Lcom/android/server/am/ActivityStack$ActivityState;

    iput-object v10, v6, Lcom/android/server/am/ActivityRecord;->state:Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    invoke-virtual {v10}, Lcom/android/server/am/TaskRecord;->touchActiveTime()V
    ...
    invoke-virtual {v10, v11}, Lcom/android/server/am/ActivityManagerService;->addRecentTaskLocked(Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-virtual {v10, v11, v12, v13}, Lcom/android/server/am/ActivityManagerService;->updateLruProcessLocked(Lcom/android/server/am/ProcessRecord;ZZ)V

    .line 1636
    invoke-direct {p0, v6}, Lcom/android/server/am/ActivityStack;->updateLRUListLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    iget-object v12, v10, Lcom/android/server/am/ActivityManagerService;->mWindowManager:Lcom/android/server/wm/WindowManagerService;

    iget-object v10, p0, Lcom/android/server/am/ActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-object v13, v10, Lcom/android/server/am/ActivityManagerService;->mConfiguration:Landroid/content/res/Configuration;

    iget-object v10, v6, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;

    invoke-virtual {v6, v10}, Lcom/android/server/am/ActivityRecord;->mayFreezeScreenLocked(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :goto_5
    invoke-virtual {v12, v13, v10}, Lcom/android/server/wm/WindowManagerService;->updateOrientationFromAppTokens(Landroid/content/res/Configuration;Landroid/os/IBinder;)Landroid/content/res/Configuration;
    ...
    iput-boolean v10, v6, Lcom/android/server/am/ActivityRecord;->frozenBeforeDestroy:Z
    ...
    invoke-virtual {v10, v2, v6, v12, v13}, Lcom/android/server/am/ActivityManagerService;->updateConfigurationLocked(Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;ZZ)Z
    ...
    .line 1662
    .local v7, nextNext:Lcom/android/server/am/ActivityRecord;
    if-eq v7, v6, :cond_c
    ...
    invoke-virtual {v10, v6}, Lcom/android/server/am/ActivityManagerService;->setFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 1672
    invoke-direct {p0, v6}, Lcom/android/server/am/ActivityStack;->suspendHDMILocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 1543
    .end local v4           #lastResumedActivity:Lcom/android/server/am/ActivityRecord;
    .end local v5           #lastState:Lcom/android/server/am/ActivityStack$ActivityState;
    .end local v7           #nextNext:Lcom/android/server/am/ActivityRecord;
    ...
    const-string v12, "Failed trying to unstop package "
    ...
    iget-object v11, v10, Lcom/android/server/am/ActivityManagerService;->mWindowManager:Lcom/android/server/wm/WindowManagerService;
    ...
    .line 1643
    .restart local v4       #lastResumedActivity:Lcom/android/server/am/ActivityRecord;
    .restart local v5       #lastState:Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    :cond_17
    :try_start_3
    iget-object v1, v6, Lcom/android/server/am/ActivityRecord;->results:Ljava/util/ArrayList;
    ...
    invoke-interface {v10, v11, v1}, Landroid/app/IApplicationThread;->scheduleSendResult(Landroid/os/IBinder;Ljava/util/List;)V

    .line 1689
    .end local v0           #N:I
    :cond_18
    iget-object v10, v6, Lcom/android/server/am/ActivityRecord;->newIntents:Ljava/util/ArrayList;
    ...
    iget-object v11, v6, Lcom/android/server/am/ActivityRecord;->newIntents:Ljava/util/ArrayList;

    iget-object v12, v6, Lcom/android/server/am/ActivityRecord;->appToken:Landroid/view/IApplicationToken$Stub;

    invoke-interface {v10, v11, v12}, Landroid/app/IApplicationThread;->scheduleNewIntent(Ljava/util/List;Landroid/os/IBinder;)V
    ...
    iget-object v13, v6, Lcom/android/server/am/ActivityRecord;->shortComponentName:Ljava/lang/String;
    ...
    .line 1698
    invoke-virtual {p0, v6}, Lcom/android/server/am/ActivityStack;->showAskCompatModeDialogLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-interface {v10, v11, v12}, Landroid/app/IApplicationThread;->scheduleResumeActivity(Landroid/os/IBinder;Z)V
    ...
    .line 1733
    invoke-direct {p0, v6}, Lcom/android/server/am/ActivityStack;->completeResumeLocked(Lcom/android/server/am/ActivityRecord;)V
    :try_end_4
    ...
    iput-object v10, v6, Lcom/android/server/am/ActivityRecord;->icicle:Landroid/os/Bundle;

    .line 1746
    const/4 v10, 0x0

    iput-boolean v10, v6, Lcom/android/server/am/ActivityRecord;->haveState:Z

    .line 1747
    const/4 v10, 0x0

    iput-boolean v10, v6, Lcom/android/server/am/ActivityRecord;->stopped:Z
    ...
    const-string v12, "Restarting because process died: "
    ...
    .line 1712
    iget-boolean v10, v6, Lcom/android/server/am/ActivityRecord;->hasBeenLaunched:Z
    ...
    iput-boolean v10, v6, Lcom/android/server/am/ActivityRecord;->hasBeenLaunched:Z
    ...
    invoke-direct {p0, v6, v10, v11}, Lcom/android/server/am/ActivityStack;->startSpecificActivityLocked(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    .line 1734
    .end local v3           #e:Ljava/lang/Exception;
    .restart local v1       #a:Ljava/util/ArrayList;
    :catch_2
    move-exception v3
    ...
    const-string v12, "Exception thrown during resume of "
    ...
    invoke-virtual {p0, v10, v11, v12, v13}, Lcom/android/server/am/ActivityStack;->requestFinishActivityLocked(Landroid/os/IBinder;ILandroid/content/Intent;Ljava/lang/String;)Z
...
.method final setReceiver()V
    ...
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->HDMIListener:Landroid/content/BroadcastReceiver;
    ...
    .end local v0           #filter:Landroid/content/IntentFilter;
    iget-object v1, p0, Lcom/android/server/am/ActivityStack;->suspendIntent:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->suspendIntentListener:Landroid/content/BroadcastReceiver;
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIZZ[Lcom/android/server/am/ActivityRecord;)I
    ...
    .line 2520
    .local v29, metaData:Landroid/os/Bundle;
    if-eqz v29, :cond_f
    ...
    .end local v29           #metaData:Landroid/os/Bundle;
    ...
    invoke-interface {v3, v4, v7, v0}, Lcom/lge/cappuccino/IMdm;->checkStartActivityLocked(Landroid/content/ComponentName;Landroid/content/Context;Landroid/content/pm/ActivityInfo;)I
    ...
    invoke-interface {v3, v4, v7}, Lcom/lge/cappuccino/IMdm;->isMessageApp(Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    invoke-interface {v3, v4}, Lcom/lge/cappuccino/IMdm;->checkUnsignedApplicationEnable(Ljava/lang/String;)Z
    ...
    invoke-interface {v3, v4}, Lcom/lge/cappuccino/IMdm;->checkApplicationEnable(Ljava/lang/String;)Z
    ...
    invoke-interface {v3, v4}, Lcom/lge/cappuccino/IMdm;->getAllowScreenCapture(Landroid/content/ComponentName;)Z
    ...
    const-string v4, "LGMDM Block ScreenCapture"
    ...
    invoke-interface {v3, v4}, Lcom/lge/cappuccino/IMdm;->checkAllowScreenCaptureWithBlacklist(Landroid/content/ComponentName;)Z
    ...
    const-string v4, "LGMDM Block ScreenCapture by blacklist"
    ...
    iget-boolean v3, v0, Landroid/content/Intent;->mReal3DIsChain:Z
    ...
    iput-object v3, v0, Landroid/content/Intent;->mReal3DProfile:Landroid/opengl/EGLReal3DProfile;
    ...
    .line 2660
    new-instance v31, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;

    invoke-direct/range {v31 .. v31}, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;-><init>()V

    .line 2661
    .local v31, pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    ...
    .line 2650
    .end local v31           #pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    :cond_1e
    ...
    invoke-direct {v0, v1, v3}, Lcom/android/server/am/ActivityStack;->findSameTasks(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)Ljava/util/List;

    move-result-object v24

    .line 2651
    .local v24, historyLists:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/am/ActivityRecord;>;"
    ...
    .line 2652
    .local v25, hr:Lcom/android/server/am/ActivityRecord;
    move-object/from16 v0, v25
    ...
    invoke-direct {v0, v1, v3}, Lcom/android/server/am/ActivityStack;->copyIntentExtra(Landroid/content/Intent;Landroid/content/Intent;)V

    goto :goto_5

    .line 2672
    .end local v24           #historyLists:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/am/ActivityRecord;>;"
    .end local v25           #hr:Lcom/android/server/am/ActivityRecord;
