...
.field private static final EVENT_CDMA_FWD_BURST_DTMF:I = 0x7a

.field private static final EVENT_CDMA_FWD_CONT_DTMF_START:I = 0x7b

.field private static final EVENT_CDMA_FWD_CONT_DTMF_STOP:I = 0x7c
...
.field protected final mCdmaFwdBurstDTMFStartRegistrants:Landroid/os/RegistrantList;

.field protected final mCdmaFwdBurstDTMFStopRegistrants:Landroid/os/RegistrantList;

.field protected final mCdmaFwdContDtmfStartRegistrants:Landroid/os/RegistrantList;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallManager;->mCdmaFwdContDtmfStartRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallManager;->mCdmaFwdBurstDTMFStartRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallManager;->mCdmaFwdBurstDTMFStopRegistrants:Landroid/os/RegistrantList;
...
.method static synthetic access$002(Lcom/android/internal/telephony/CallManager;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private registerForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    const-string/jumbo v1, "support_cdma_forward_burst_dtmf"
    ...
    invoke-interface {p1, v0, v1, v2}, Lcom/android/internal/telephony/Phone;->registerForCdmaFwdBurstDtmf(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {p1, v0, v1, v2}, Lcom/android/internal/telephony/Phone;->registerForCdmaFwdContDtmfStart(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {p1, v0, v1, v2}, Lcom/android/internal/telephony/Phone;->registerForCdmaFwdContDtmfStop(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string/jumbo v1, "support_cdg2_test"
...
.method private unregisterForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-interface {p1, v0}, Lcom/android/internal/telephony/Phone;->unregisterForCdmaFwdBurstDtmf(Landroid/os/Handler;)V

    .line 537
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mHandler:Landroid/os/Handler;

    invoke-interface {p1, v0}, Lcom/android/internal/telephony/Phone;->unregisterForCdmaFwdContDtmfStart(Landroid/os/Handler;)V

    .line 538
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mHandler:Landroid/os/Handler;

    invoke-interface {p1, v0}, Lcom/android/internal/telephony/Phone;->unregisterForCdmaFwdContDtmfStop(Landroid/os/Handler;)V
...
.method public explicitCallTransfer(Lcom/android/internal/telephony/Call;)V
    ...
    invoke-interface {v0, v1}, Lcom/android/internal/telephony/Phone;->explicitCallTransfer(Z)V
...
.method public registerForCdmaFwdBurstDtmf(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .prologue
    .line 1621
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mCdmaFwdContDtmfStartRegistrants:Landroid/os/RegistrantList;
...
.method public registerForCdmaFwdContDtmfStart(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .prologue
    .line 1629
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mCdmaFwdBurstDTMFStartRegistrants:Landroid/os/RegistrantList;
...
.method public registerForCdmaFwdContDtmfStop(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .prologue
    .line 1637
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mCdmaFwdBurstDTMFStopRegistrants:Landroid/os/RegistrantList;
