...
.field protected static final EVENT_NOTIFY_DATA_CONNECTION_DELAYED:I = 0x36
...
.field protected mRD:Lcom/android/internal/telephony/cdma/CdmaRILEventDispatcher;
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Z)V
    ...
    .line 164
    iput-object v8, p0, Lcom/android/internal/telephony/PhoneBase;->mUiccManager:Lcom/android/internal/telephony/UiccManager;
    ...
    .line 178
    const-string/jumbo v4, "persist.telephony.oosisdc"

    invoke-static {v4, v7}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v4

    iput-boolean v4, p0, Lcom/android/internal/telephony/PhoneBase;->mOosIsDisconnect:Z

    .line 187
    iput-boolean v7, p0, Lcom/android/internal/telephony/PhoneBase;->mVmUrgent:Z
    ...
    invoke-interface {v4, p0, v5, v8}, Lcom/android/internal/telephony/CommandsInterface;->setOnCallRing(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 309
    const-string/jumbo v4, "ro.telephony.call_ring.multiple"
    ...
    const-string/jumbo v6, "mDoesRilSendMultipleCallRing="
    ...
    .line 313
    const-string/jumbo v4, "ro.telephony.call_ring.delay"
    ...
    const-string/jumbo v6, "mCallRingDelay="
    ...
    const-string/jumbo v6, "mOosIsDisconnect="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v6, p0, Lcom/android/internal/telephony/PhoneBase;->mOosIsDisconnect:Z
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/lgeAutoProfiling;->isCountry(Ljava/lang/String;)Z
    ...
    .line 320
    invoke-static {p2}, Lcom/android/internal/telephony/TelephonyUtils;->parseKrTelephonyStringXML(Landroid/content/Context;)V

    .line 324
    :cond_0
    const-string/jumbo v4, "lgu_global_roaming"

    invoke-static {v8, v4}, Lcom/android/internal/telephony/lgeAutoProfiling;->isSupportFeature(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string v6, "SharedPreference(mcc_change) saved mcc = "
    ...
    const-string v6, "Init SharedPreference(mcc_change) new mcc = "
    ...
    const-string/jumbo v6, "savedPropertyCamped_MccMnc = "
    ...
    invoke-static {v4, v5}, Lcom/android/internal/telephony/cdma/CdmaRILEventDispatcher;->getCdmaRILEventDispatcher(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)Lcom/android/internal/telephony/cdma/CdmaRILEventDispatcher;

    move-result-object v4

    iput-object v4, p0, Lcom/android/internal/telephony/PhoneBase;->mRD:Lcom/android/internal/telephony/cdma/CdmaRILEventDispatcher;
...
.method public dispose()V
    ...
    const-string/jumbo v2, "lgu_global_roaming"
    ...
    const-string/jumbo v3, "mRD = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mRD:Lcom/android/internal/telephony/cdma/CdmaRILEventDispatcher;
    ...
    .line 388
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mRD:Lcom/android/internal/telephony/cdma/CdmaRILEventDispatcher;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mRD:Lcom/android/internal/telephony/cdma/CdmaRILEventDispatcher;

    invoke-virtual {v0}, Lcom/android/internal/telephony/cdma/CdmaRILEventDispatcher;->dispose()V
...
.method public getBDAddress(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->getBDAddress(Landroid/os/Message;)V
...
.method public getIccCard()Lcom/android/internal/telephony/IccCard;
    ...
    const-string v1, "[du] PhoneBase::getIccCard()"
...
.method public abstract getIccCardApplication3GPP()Lcom/android/internal/telephony/UiccCardApplication;
.end method

.method public abstract getIccCardApplication3GPP2()Lcom/android/internal/telephony/UiccCardApplication;
.end method
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v5, "Event EVENT_NOTIFY_DATA_CONNECTION_DELAYED Received APN_Type= "
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/PhoneBase;->getDataConnectionState(Ljava/lang/String;)Lcom/android/internal/telephony/Phone$DataState;

    move-result-object v6

    invoke-interface {v7, v3, v4, v5, v6}, Lcom/android/internal/telephony/PhoneNotifier;->notifyDataConnection(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/Phone$DataState;)V
...
.method public notifyDataConnection(Ljava/lang/String;)V
    ...
    iget-boolean v5, v5, Lcom/android/internal/telephony/LGfeature;->notify_data_connection_delay:Z
    ...
    invoke-virtual {v5, v0}, Lcom/android/internal/telephony/DataConnectionTracker;->getState(Ljava/lang/String;)Lcom/android/internal/telephony/DataConnectionTracker$State;
    ...
    invoke-virtual {p0, p0, p1, v0, v5}, Lcom/android/internal/telephony/PhoneBase;->notifyDataConnectionDelayed(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/Phone$DataState;)V
...
.method public notifyDataConnection(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/LGfeature;->notify_data_connection_delay:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mDataConnectionTracker:Lcom/android/internal/telephony/DataConnectionTracker;

    invoke-virtual {v0, p2}, Lcom/android/internal/telephony/DataConnectionTracker;->getState(Ljava/lang/String;)Lcom/android/internal/telephony/DataConnectionTracker$State;
    ...
    invoke-virtual {p0, p0, p1, p2, v0}, Lcom/android/internal/telephony/PhoneBase;->notifyDataConnectionDelayed(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/Phone$DataState;)V
...
.method public notifyDataConnection(Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/Phone$DataState;)V
    ...
    .line 1023
    invoke-virtual {p0, p0, p1, p2, p3}, Lcom/android/internal/telephony/PhoneBase;->notifyDataConnectionDelayed(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/Phone$DataState;)V
...
.method public notifyDataConnectionDelayed(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/Phone$DataState;)V
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lcom/android/internal/telephony/PhoneNotifier;->notifyDataConnection(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/Phone$DataState;)V
...
.method public prepareEri()V
    ...
    .prologue
    .line 1553
    const-string/jumbo v0, "prepareEri"
...
.method public registerForDunValue(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/CommandsInterface;->registerForDunValue(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public resetVoiceMessageCount()V
    ...
    .prologue
    .line 1507
    const-string/jumbo v0, "resetVoiceMessageCount"
...
.method public sendSMS(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/CommandsInterface;->sendSMS(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public setCdmaEriVersion(ILandroid/os/Message;)V
    ...
    .prologue
    .line 1586
    const-string/jumbo v0, "setCdmaEriVersion"
...
.method public unregisterForDunValue(Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForDunValue(Landroid/os/Handler;)V
