...
.field private static final TAG:Ljava/lang/String; = "PhoneProxy"
...
.field private mSmartCardManager:Lcom/android/internal/telephony/SmartCardManager;

.field private mUsimLibService:Lcom/android/internal/telephony/gsm/UsimLibService;

.field private mUsimMgr:Lcom/android/internal/telephony/UsimInterfaceManager;
...
.method public constructor <init>(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-interface {v1, p0, v2, v4}, Lcom/android/internal/telephony/CommandsInterface;->registerForVoiceRadioTechChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string v2, "[PhoneProxy] make UsimLibService"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 109
    new-instance v1, Lcom/android/internal/telephony/gsm/UsimLibService;

    invoke-direct {v1, p0}, Lcom/android/internal/telephony/gsm/UsimLibService;-><init>(Lcom/android/internal/telephony/PhoneProxy;)V

    iput-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mUsimLibService:Lcom/android/internal/telephony/gsm/UsimLibService;

    .line 110
    new-instance v2, Lcom/android/internal/telephony/SmartCardManager;

    iget-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    check-cast v1, Lcom/android/internal/telephony/PhoneBase;

    invoke-direct {v2, v1}, Lcom/android/internal/telephony/SmartCardManager;-><init>(Lcom/android/internal/telephony/PhoneBase;)V

    iput-object v2, p0, Lcom/android/internal/telephony/PhoneProxy;->mSmartCardManager:Lcom/android/internal/telephony/SmartCardManager;

    .line 114
    :cond_0
    const-string v1, "PHONE"

    const-string v2, "[PhoneProxy] make UsimInterfaceManager"
    ...
    invoke-static {v1}, Lcom/android/internal/telephony/UsimInterfaceManager;->getInstance(Lcom/android/internal/telephony/Phone;)Lcom/android/internal/telephony/UsimInterfaceManager;

    move-result-object v1

    iput-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mUsimMgr:Lcom/android/internal/telephony/UsimInterfaceManager;
    :try_end_0
    ...
    const-string v2, "[PhoneProxy] end creating UsimInterfaceManager instance"
    ...
    invoke-static {v1, v2, v4}, Lcom/android/internal/telephony/LgeNetworkInfo;->getInstance(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/CommandsInterface;Ljava/lang/Object;)Lcom/android/internal/telephony/LgeNetworkInfo;
...
.method private deleteAndCreatePhone(I)V
    ...
    invoke-static {v4, v2}, Lcom/android/internal/telephony/lgeAutoProfiling;->isSupportFeature(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v2, v3, v4}, Lcom/android/internal/telephony/LgeNetworkInfo;->getInstance(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/CommandsInterface;Ljava/lang/Object;)Lcom/android/internal/telephony/LgeNetworkInfo;
...
.method public explicitCallTransfer(Z)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->explicitCallTransfer(Z)V
...
.method public getBDAddress(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->getBDAddress(Landroid/os/Message;)V
...
.method public getCurrentLine()I
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->getCurrentLine()I
...
.method public getEmodeInfoPage(I)Ljava/lang/String;
    ...
    const-string v1, "[PhoneProxy] getEmodeInfoPage"
...
.method public getEngineeringModeInfo(ILandroid/os/Message;)I
    ...
    const-string v1, "[PhoneProxy] getEngineeringModeInfo"
...
.method public getIccCard()Lcom/android/internal/telephony/IccCard;
    ...
    const-string v2, "[du] PhoneProxy::getIccCard() : "
...
.method public getServiceLine(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->getServiceLine(Landroid/os/Message;)V
...
.method public getUsimAuthentication(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;ILandroid/os/Message;)V
    ...
    invoke-interface/range {v0 .. v6}, Lcom/android/internal/telephony/CommandsInterface;->getUsimAuthentication(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;ILandroid/os/Message;)V
...
.method public getVoiceMailNumberForALS(I)Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->getVoiceMailNumberForALS(I)Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v3, "EVENT_REQUEST_VOICE_RADIO_TECH_DONE: newVoiceTech = "
...
.method public isTwoLineSupported()Z
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->isTwoLineSupported()Z
...
.method public registerForDunValue(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->registerForDunValue(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public sendSMS(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->sendSMS(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public setCallDeflection(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->setCallDeflection(Ljava/lang/String;)V
...
.method public setServiceLine(ILandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/Phone;->setServiceLine(ILandroid/os/Message;)V
...
.method public setVoiceMailNumberForALS(ILjava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lcom/android/internal/telephony/Phone;->setVoiceMailNumberForALS(ILjava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public unregisterForDunValue(Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->unregisterForDunValue(Landroid/os/Handler;)V
