...
.field private mIsCallTransfer:Z

.field private mIsColdTransfer:Z

.field private mIsOnHold:Z

.field private mLastConnection:Lcom/android/internal/telephony/gsm/GsmConnection;
...
.method constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 93
    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsColdTransfer:Z

    .line 94
    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mLastConnection:Lcom/android/internal/telephony/gsm/GsmConnection;

    .line 95
    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsCallTransfer:Z

    .line 96
    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsOnHold:Z
...
.method private getFailedService(I)Lcom/android/internal/telephony/Phone$SuppService;
    ...
    .line 1268
    :pswitch_5
    sget-object v0, Lcom/android/internal/telephony/Phone$SuppService;->DEFLECTION:Lcom/android/internal/telephony/Phone$SuppService;
...
.method dial(ILjava/lang/String;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->dial(ILjava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
...
.method dial(ILjava/lang/String;I)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->dial(ILjava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
...
.method dial(ILjava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    .locals 7
    .parameter "whichLine"
    .parameter "dialString"
    .parameter "clirMode"
    ...
    const-string/jumbo v1, "support_network_change_auto_retry"
    ...
    const-string/jumbo v1, "network_change_auto_retry"
    ...
    const-string/jumbo v1, "network_change_auto_retry_number"
    ...
    invoke-interface/range {v0 .. v5}, Lcom/android/internal/telephony/CommandsInterface;->dial(ILjava/lang/String;ILcom/android/internal/telephony/UUSInfo;Landroid/os/Message;)V

    goto :goto_0
.end method

.method dial(ILjava/lang/String;Lcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    .locals 1
    .parameter "whichLine"
    .parameter "dialString"
    .parameter "uusInfo"
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->dial(ILjava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
...
.method dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    const-string/jumbo v3, "support_network_change_auto_retry"
    ...
    const-string/jumbo v3, "network_change_auto_retry"
    ...
    const-string/jumbo v3, "network_change_auto_retry_number"
...
.method dial(Ljava/lang/String;IZLcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    .locals 5
    .parameter "dialString"
    .parameter "clirMode"
    .parameter "subaddress"
    ...
    const-string v3, "[TEL-FRW]dial() dialString="
    ...
    invoke-direct {v1, v2, v0, p0, v3}, Lcom/android/internal/telephony/gsm/GsmConnection;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/internal/telephony/gsm/GsmCallTracker;Lcom/android/internal/telephony/gsm/GsmCall;)V
    ...
    .line 304
    .end local v0           #newDialString:Ljava/lang/String;
    :cond_4
    const/4 v1, 0x2
    ...
    .restart local v0       #newDialString:Ljava/lang/String;
    goto/16 :goto_0
    ...
    invoke-interface {v1, v2, p2, p4, v3}, Lcom/android/internal/telephony/CommandsInterface;->dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Landroid/os/Message;)V
...
.method explicitCallTransfer(Z)V
    .locals 2
    ...
    .line 551
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->canTransfer()Z
    ...
    const-string v1, "Cannot transfer call"
    ...
    .line 559
    :cond_1
    iput-boolean v0, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsColdTransfer:Z

    .line 560
    iput-boolean v0, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsCallTransfer:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1293
    iput-object v12, p0, Lcom/android/internal/telephony/CallTracker;->lastRelevantPoll:Landroid/os/Message;
    ...
    .line 1297
    :cond_2
    iget-boolean v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsCallTransfer:Z
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/gsm/GsmCall;->getLatestConnection()Lcom/android/internal/telephony/Connection;

    move-result-object v9

    check-cast v9, Lcom/android/internal/telephony/gsm/GsmConnection;

    iput-object v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mLastConnection:Lcom/android/internal/telephony/gsm/GsmConnection;
    ...
    invoke-interface {v9, v10}, Lcom/android/internal/telephony/CommandsInterface;->explicitCallTransfer(Landroid/os/Message;)V

    .line 1300
    iput-boolean v11, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsCallTransfer:Z
    ...
    const-string v12, "EVENT_ECT_RESULT"
    ...
    const-string v12, "EVENT_ECT_RESULT: exception"

    invoke-static {v9, v12}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1343
    iget-boolean v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsColdTransfer:Z
    ...
    :try_start_0
    iput-boolean v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsColdTransfer:Z

    .line 1347
    iget-object v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mLastConnection:Lcom/android/internal/telephony/gsm/GsmConnection;

    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->hangup(Lcom/android/internal/telephony/gsm/GsmConnection;)V
    ...
    .line 1349
    iget-object v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->backgroundCall:Lcom/android/internal/telephony/gsm/GsmCall;
    ...
    :goto_2
    iput-boolean v10, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsOnHold:Z
    :try_end_0
    .catch Lcom/android/internal/telephony/CallStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1352
    .local v3, exc:Lcom/android/internal/telephony/CallStateException;
    const-string v9, "GSM"

    const-string v10, "EVENT_ECT_RESULT: CallStateException"
    ...
    .line 1359
    .end local v3           #exc:Lcom/android/internal/telephony/CallStateException;
    :cond_8
    ...
    const-string v12, "EVENT_ECT_RESULT: res_Failed"
    ...
    :goto_4
    iput-boolean v9, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsOnHold:Z
    :try_end_1
    .catch Lcom/android/internal/telephony/CallStateException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    .line 1372
    .restart local v3       #exc:Lcom/android/internal/telephony/CallStateException;
    const-string v9, "GSM"
    ...
    .end local v3           #exc:Lcom/android/internal/telephony/CallStateException;
    :cond_b
    iput-boolean v11, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mIsColdTransfer:Z
    ...
    const-string v10, "EVENT_CALLDEFLECTION_RESULT"
    ...
    const-string v10, "EVENT_CALLDEFLECTION_RESULT: exception"
    ...
    const-string v10, "EVENT_CALLDEFLECTION_RESULT: res_Failed"
...
.method hangupAllCalls()V
    ...
    .line 1078
    const-string/jumbo v1, "hangupAllCalls: hang up ringing call"
    ...
    .line 1085
    const-string/jumbo v1, "hangupAllCalls: hang up active call"
    ...
    .line 1091
    const-string/jumbo v1, "hangupAllCalls: hang up held call"
...
.method setCallDeflection(Ljava/lang/String;)V
    .locals 2
    .parameter "number"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-interface {v0, p1, v1}, Lcom/android/internal/telephony/CommandsInterface;->setCallDeflection(Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v1, "Cannot deflect call"
