...
.field protected static final EVENT_BLOCK_EHRPD_INTERNET_IPV6:I = 0x33
...
.field protected static final EVENT_WCDMA_CAMPED_MCCMNC:I = 0x32

.field protected static final EVENT_WCDMA_NET_CHANGED:I = 0x2e

.field protected static final EVENT_WCDMA_NET_TO_KOREA_CHANGED:I = 0x2f
...
.field protected static isOemRadDialerPopupSettingInit:Z

.field private static mIsWcdmaNetChangedReceived:Z

.field private static mLostNitzReceived:Z

.field private static mLostNitzReceivedMcc:Ljava/lang/String;

.field private static mLostNitzSavedAtTiem:J
...
.method static constructor <clinit>()V
    ...
    .line 168
    sput-boolean v2, Lcom/android/internal/telephony/ServiceStateTracker;->isOemRadDialerPopupSettingInit:Z
    ...
    sput-wide v0, Lcom/android/internal/telephony/ServiceStateTracker;->mLostNitzSavedAtTiem:J

    .line 628
    sput-boolean v2, Lcom/android/internal/telephony/ServiceStateTracker;->mLostNitzReceived:Z

    .line 629
    const-string v0, ""

    sput-object v0, Lcom/android/internal/telephony/ServiceStateTracker;->mLostNitzReceivedMcc:Ljava/lang/String;

    .line 655
    sput-boolean v2, Lcom/android/internal/telephony/ServiceStateTracker;->mIsWcdmaNetChangedReceived:Z
...
.method protected static getLostNitzMcc()Ljava/lang/String;
    .locals 1

    .prologue
    .line 642
    sget-object v0, Lcom/android/internal/telephony/ServiceStateTracker;->mLostNitzReceivedMcc:Ljava/lang/String;

    return-object v0
.end method

.method protected static getLostNitzSavedTime()J
    .locals 2

    .prologue
    .line 638
    sget-wide v0, Lcom/android/internal/telephony/ServiceStateTracker;->mLostNitzSavedAtTiem:J

    return-wide v0
.end method

.method private getRadioTechnology_GSM()Z
    .locals 3
    ...
    const-string v2, "[LGE_DATA] tech_gsm :: "
...
.method protected static getWcdmaNetChangedReceived()Z
    .locals 1

    .prologue
    .line 662
    sget-boolean v0, Lcom/android/internal/telephony/ServiceStateTracker;->mIsWcdmaNetChangedReceived:Z

    return v0
.end method

.method private isKrForIMS()Z
    .locals 4
    ...
    const-string v3, "[LGE_DATA] isKrForIMS :: "
...
.method private isWantSendDetach()Z
    .locals 4
    ...
    const-string v3, "[LGE_DATA] only_detach :: "
...
.method protected static resetLostNitzInfo()V
    .locals 2
    ...
    sput-boolean v0, Lcom/android/internal/telephony/ServiceStateTracker;->mLostNitzReceived:Z

    .line 649
    return-void
.end method

.method protected static setLostNitzInfo(JLjava/lang/String;)V
    .locals 1
    .parameter "savedAtTime"
    .parameter "nitzMcc"

    .prologue
    .line 632
    sput-wide p0, Lcom/android/internal/telephony/ServiceStateTracker;->mLostNitzSavedAtTiem:J

    .line 633
    sput-object p2, Lcom/android/internal/telephony/ServiceStateTracker;->mLostNitzReceivedMcc:Ljava/lang/String;
...
.method protected static setWcdmaNetChangedReceived(Z)V
    .locals 0
    .parameter "received"

    .prologue
    .line 658
    sput-boolean p0, Lcom/android/internal/telephony/ServiceStateTracker;->mIsWcdmaNetChangedReceived:Z
...
.method public abstract get_ifacename_ipv6_blocked_by_ip6table()Ljava/lang/String;
.end method

.method public abstract get_internetpdn_ipv6_blocked_by_ip6table()Z
.end method
...
.method public powerOffRadioSafely(Lcom/android/internal/telephony/DataConnectionTracker;)V
    ...
    iget-boolean v1, v1, Lcom/android/internal/telephony/LGfeature;->PowerOff_OnlyDettach:Z
    ...
    iget-boolean v1, v1, Lcom/android/internal/telephony/LGfeature;->closeDelayForIms:Z

    if-eqz v1, :cond_1

    invoke-virtual {p1}, Lcom/android/internal/telephony/DataConnectionTracker;->isCompleteIMSforDelayTime()Z
...
.method public abstract set_ifacename_ipv6_blocked_by_ip6table(Ljava/lang/String;)V
.end method
