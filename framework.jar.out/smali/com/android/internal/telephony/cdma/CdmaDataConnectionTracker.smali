...
.field private static final DUN_DISABLED:I = 0x3

.field private static final DUN_END:I = 0x2

.field private static final DUN_START:I = 0x1
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mDun:I
...
.method constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    invoke-interface {v0, p0, v1, v3}, Lcom/android/internal/telephony/CommandsInterface;->registerForDunValue(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 143
    new-instance v0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker$CDMAApnObserver;

    invoke-direct {v0, p0}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker$CDMAApnObserver;-><init>(Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;)V

    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mApnObserver:Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker$CDMAApnObserver;
...
.method public dispose()V
    ...
    invoke-virtual {p0, v1, v0, v1}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->cleanUpConnection(ZLjava/lang/String;Z)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1096
    iget-boolean v0, p0, Lcom/android/internal/telephony/DataConnectionTracker;->datablockbyadmin:Z

    if-eqz v0, :cond_1

    .line 1097
    const-string v0, "AdminDisabled"

    const/4 v1, 0x0

    invoke-virtual {p0, v2, v0, v1}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->cleanUpConnection(ZLjava/lang/String;Z)V

    goto :goto_0

    .line 1102
    :sswitch_8
    const-string v0, "[MIN]DUN_MOD_CHANGE!!"
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->setDunValue(Landroid/os/AsyncResult;)V
...
.method protected isDataAllowed()Z
    ...
    iget-boolean v10, v10, Lcom/android/internal/telephony/LGfeature;->SendDisableinfotoModem:Z
    ...
    .line 243
    const-string/jumbo v8, "there are no admin pdn so block"
    ...
    iget-object v10, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mIccRecords:Lcom/android/internal/telephony/IccRecords;
    ...
    iget-boolean v9, v9, Lcom/android/internal/telephony/LGfeature;->disallowed1xDataCall:Z
    ...
    .line 284
    :cond_9
    sget v9, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mDun:I
    ...
    .line 286
    const-string v8, "[MIN]mDun = 1 : dun calling, so block trySetup!!"
    ...
    iget-object v8, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mIccRecords:Lcom/android/internal/telephony/IccRecords;
...
.method protected setDunValue(Landroid/os/AsyncResult;)V
    .locals 4
    .parameter "ar"
    ...
    sput v1, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mDun:I
    ...
    const-string v2, "[MIN]mDun = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget v2, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mDun:I
    ...
    .line 1207
    sget v1, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mDun:I
    ...
    const-string v2, "[MIN]setDunValue : Invalid value - "
...
.method protected updateIccAvailability()V
    ...
    .line 1146
    const-string/jumbo v1, "newIccRecords are assigned to 3GPP records."
