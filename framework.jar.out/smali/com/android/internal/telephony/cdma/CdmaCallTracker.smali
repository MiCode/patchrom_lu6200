...
.method constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mAssistDialPhoneNumberUtils:Landroid/telephony/AssistDialPhoneNumberUtils;
...
.method private internalClearDisconnected()V
    ...
    const-string/jumbo v1, "internalClearDisconnected ringingCall="
...
.method dial(Ljava/lang/String;I)Lcom/android/internal/telephony/Connection;
    ...
    const-string/jumbo v6, "support_nbpcb"
    ...
    iget-object v5, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mAssistDialPhoneNumberUtils:Landroid/telephony/AssistDialPhoneNumberUtils;
    ...
    invoke-virtual {v5, v6}, Landroid/telephony/AssistDialPhoneNumberUtils;->getIsAssistedDialCheck(Landroid/content/Context;)I
    ...
    invoke-static {v5}, Landroid/telephony/CallNbpcdAPI;->setUpProcess(Landroid/content/Context;)V

    .line 241
    invoke-static {p1}, Landroid/telephony/CallNbpcdAPI;->plusDialDecision(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, p1, v6}, Landroid/telephony/AssistDialPhoneNumberUtils;->getAssitedDialFinalNumberForCDMA(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v6, "support_network_change_auto_retry"
    ...
    const-string v6, " *********** Emergency Number True!!"
    ...
    const-string/jumbo v6, "network_change_auto_retry"
    ...
    const-string/jumbo v6, "network_change_auto_retry_number"
    ...
    invoke-virtual {v5, v9}, Lcom/android/internal/telephony/cdma/CdmaCall;->setGeneric(Z)V
    ...
    :cond_7
    new-instance v5, Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    invoke-direct {v5, v6, p1, p0, v7}, Lcom/android/internal/telephony/cdma/CdmaConnection;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/internal/telephony/cdma/CdmaCallTracker;Lcom/android/internal/telephony/cdma/CdmaCall;)V

    iput-object v5, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->pendingMO:Lcom/android/internal/telephony/cdma/CdmaConnection;

    .line 298
    iput-boolean v9, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->hangupPendingMO:Z
    ...
    iput-object v6, v5, Lcom/android/internal/telephony/cdma/CdmaConnection;->cause:Lcom/android/internal/telephony/Connection$DisconnectCause;
    ...
    const-string v6, "dial: Connection.DisconnectCause.INVALID_NUMBER pendingMO="
    ...
    const-string v6, "NotDisableDataCallInEmergencyCall"
    ...
    invoke-interface {v5, v6, p2, v7}, Lcom/android/internal/telephony/CommandsInterface;->dial(Ljava/lang/String;ILandroid/os/Message;)V
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/cdma/CDMAPhone;->exitEmergencyCallbackMode()V
    ...
    invoke-virtual {v5, p0, v6, v7}, Lcom/android/internal/telephony/cdma/CDMAPhone;->setOnEcbModeExitResponse(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1210
    const-string/jumbo v7, "handle EVENT_POLL_CALL_RESULT: set needsPoll=F"
    ...
    const-string v7, "android.intent.action.LGT_OTA_RES_NOTIF_FAIL"
    ...
    .line 1264
    invoke-virtual {v3, v4, v9}, Landroid/content/Context;->sendOrderedBroadcast(Landroid/content/Intent;Ljava/lang/String;)V
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    .line 664
    const-string v18, "[CDMACalllTracker] CASE1 : conn == null && dc != null"
    ...
    .line 710
    const-string v18, "[CdmaCallTracker] CASE2 : conn != null && dc == null"
    ...
    .line 753
    const-string v18, "[CdmaCallTracker] CASE3 : conn != null && dc != null"
    ...
    .line 755
    const-string v18, "[CdmaCallTracker] conn.isIncoming != dc.isMT"
    ...
    .line 817
    const-string v18, "[handlePollCalls] newRinging != null : phone.notifyNewRingingConnection(newRinging)"
    ...
    .line 831
    const-string v18, "[handlePollCalls] conn.cause == Connection.DisconnectCause.LOCAL -> INCOMING_REJECTED"
    ...
    .line 834
    :cond_19
    const-string v18, "[handlePollCalls] conn.cause -> INCOMING_MISSED"
    ...
    .line 846
    const-string v18, "[handlePollCalls] dropped during poll : Local hangup"
    ...
    .line 850
    const-string v18, "[handlePollCalls] dropped during poll : INVALID_NUMBER"
    ...
    .line 858
    const-string v18, "[handlePollCalls] droppedDuringPoll.size() > 0 : EVENT_GET_LAST_CALL_FAIL_CAUSE"
    ...
    .line 864
    const-string v18, "[handlePollCalls] needsPollDelay == true : EVENT_REPOLL_AFTER_DELAY"
    ...
    .line 874
    :cond_1f
    const-string v18, "[handlePollCalls] newRinging != null || hasNonHangupStateChanged : internalClearDisconnected"
    ...
    .line 878
    :cond_20
    const-string v18, "[handlePollCalls] updatePhoneState START"
    ...
    .line 882
    const-string v18, "[handlePollCalls] unknownConnectionAppeared : phone.notifyUnknownConnection()"
    ...
    .line 887
    :cond_22
    const-string v18, "[handlePollCalls] hasNonHangupStateChanged || newRinging != null : phone.notifyPreciseCallStateChanged()"
