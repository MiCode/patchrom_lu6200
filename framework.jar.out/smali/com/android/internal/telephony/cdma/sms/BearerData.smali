...
.field private static final E_RECORD_TYPE_0:B = 0x0t

.field private static final E_RECORD_TYPE_1:B = 0x1t

.field private static final E_RECORD_TYPE_2:B = 0x2t
...
.field public mSCPData:Lcom/android/internal/telephony/cdma/sms/SCPData;

.field public mSCPResult:Lcom/android/internal/telephony/cdma/sms/SCPResult;
...
.method public static calcTextEncodingDetailsEx(Ljava/lang/CharSequence;Z)Lcom/android/internal/telephony/SmsMessageBase$TextEncodingDetails;
    .locals 7
    .parameter "msg"
    .parameter "force7BitEncoding"
    ...
    .line 2639
    invoke-static {v3}, Lcom/android/internal/telephony/cdma/sms/BearerData;->getLmsMsgCount([B)I
    ...
    .line 2640
    sget v5, Landroid/telephony/SmsMessage;->MAX_USER_DATA_BYTES_EX:I
...
.method private static dbgPrintAlert(I)Ljava/lang/String;
    .locals 1
    .parameter "alert"
...
.method private static dbgPrintCat(I)Ljava/lang/String;
    .locals 1
    .parameter "cat"
    ...
    .line 2051
    const-string v0, "Illegal Category"
...
.method private static dbgPrintLang(I)Ljava/lang/String;
    .locals 1
    .parameter "lang"
...
.method private static dbgPrintMaxMsgs(I)Ljava/lang/String;
    .locals 1
    .parameter "max"
...
.method private static dbgPrintName([B)Ljava/lang/String;
    .locals 1
    .parameter "name"
...
.method private static dbgPrintNumField(I)Ljava/lang/String;
    .locals 1
    .parameter "num"
...
.method private static dbgPrintOpCode(I)Ljava/lang/String;
    .locals 1
    .parameter "opCode"
    ...
    .line 2034
    const-string v0, "Illegal Op Code"
    ...
    .line 2028
    :pswitch_0
    const-string v0, "Del Op Code"

    goto :goto_0

    .line 2030
    :pswitch_1
    const-string v0, "Add Op Code"

    goto :goto_0

    .line 2032
    :pswitch_2
    const-string v0, "Clear All Op Code"
...
.method private static dbgPrintResult(I)Ljava/lang/String;
    .locals 1
    .parameter "result"
    ...
    .line 2021
    :pswitch_0
    const-string v0, "Illegal result"
    ...
    .line 2017
    :pswitch_2
    const-string v0, "already opted in"

    goto :goto_0

    .line 2019
    :pswitch_3
    const-string v0, "already opted out"
...
.method private static debugPrintField(Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;)V
    .locals 3
    .parameter "field"
    ...
    const-string v2, "[field] opCode = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->opCode:I

    invoke-static {v2}, Lcom/android/internal/telephony/cdma/sms/BearerData;->dbgPrintOpCode(I)Ljava/lang/String;
    ...
    iget v2, p0, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->category:I

    invoke-static {v2}, Lcom/android/internal/telephony/cdma/sms/BearerData;->dbgPrintCat(I)Ljava/lang/String;
    ...
    const-string v2, "[field] language = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->language:I
    ...
    const-string v2, "[field] maxMsgs = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->maxMsgs:I
    ...
    const-string v2, "[field] alertOpt = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->alertOpt:I
    ...
    const-string v2, "[field] numField = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->numFields:I
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->name:[B
...
.method private static debugPrintResult(Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;)V
    .locals 3
    .parameter "field"
    ...
    iget v2, p0, Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;->category:I
    ...
    const-string/jumbo v2, "op result "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;->result:I

    invoke-static {v2}, Lcom/android/internal/telephony/cdma/sms/BearerData;->dbgPrintResult(I)Ljava/lang/String;
...
.method public static decode([BZ)Lcom/android/internal/telephony/cdma/sms/BearerData;
    ...
    const-string v9, "SUBPARAM_SERVICE_CATEGORY_PROGRAM_DATA"

    invoke-static {v8, v9}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2472
    invoke-static {v0, v4}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeSCPData(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseInputStream;)Z
    ...
    invoke-static {v8}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeCmasUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;)V
...
.method public static decodeCmas([B)Lcom/android/internal/telephony/cdma/sms/BearerData;
    ...
    invoke-static {v7, v8}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeCmasUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;Z)V
    :try_end_2
    .catch Lcom/android/internal/util/BitwiseInputStream$AccessException; {:try_start_2 .. :try_end_2} :catch_0
    .catch Lcom/android/internal/telephony/cdma/sms/BearerData$CodingException; {:try_start_2 .. :try_end_2} :catch_1
...
.method private static decodeCmasUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;Z)V
    .locals 12
    .parameter "userData"
    ...
    .line 1393
    .local v5, offset:I
    new-instance v7, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    invoke-direct {v7}, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    .line 1394
    iget-object v7, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    new-instance v8, Lcom/android/internal/telephony/cdma/sms/BearerData$TimeStamp;

    invoke-direct {v8}, Lcom/android/internal/telephony/cdma/sms/BearerData$TimeStamp;-><init>()V

    iput-object v8, v7, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->ExpireCmasTime:Lcom/android/internal/telephony/cdma/sms/BearerData$TimeStamp;

    .line 1396
    const-string v7, "CMAS_TAG"

    const-string v8, "Enter CMAS Decoding "
    ...
    .line 1410
    iput v11, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->msgEncoding:I
    ...
    .line 1419
    .local v2, decode_E_Record_Type_0_success:Z
    new-instance v4, Lcom/android/internal/util/BitwiseInputStream;
    ...
    iput v8, v7, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_protocol_version:I
    ...
    const-string/jumbo v9, "protocol type : "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    iget v9, v9, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_protocol_version:I
    ...
    iget v7, v7, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_protocol_version:I
    ...
    const-string/jumbo v9, "unsupported CMAE protocol version"
    ...
    const-string/jumbo v9, "unsupported protocol version ("
    ...
    const-string v9, "Parsing CMAS E_Record_type = "
    ...
    const-string/jumbo v8, "unknown E_RecordType"
    ...
    const-string/jumbo v9, "unsupported E_RecordType("
    ...
    const-string v8, "calling decodeE_RecordType 0"

    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1440
    const-string v7, "CMAS_MIT"
    ...
    .line 1441
    invoke-static {p0, v4, v5}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeE_RecordType0(Lcom/android/internal/telephony/cdma/sms/UserData;Lcom/android/internal/util/BitwiseInputStream;I)Z
    ...
    const-string v9, "decode_E_Record_Type_0_success = "
    ...
    const-string v8, "calling decodeE_RecordType 1"

    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1447
    invoke-static {p0, v4}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeE_RecordType1(Lcom/android/internal/telephony/cdma/sms/UserData;Lcom/android/internal/util/BitwiseInputStream;)V
    ...
    const-string v8, "calling decodeE_RecordType 2"

    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1451
    invoke-static {p0, v4}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeE_RecordType2(Lcom/android/internal/telephony/cdma/sms/UserData;Lcom/android/internal/util/BitwiseInputStream;)V
    ...
    const-string v8, "End of decodeCmasUserData() "
    ...
    const-string v9, "Value of decode_E_Record_Type_0_success = "
    ...
    const-string v8, "No E_Record_Type_0 "
...
.method private static decodeE_RecordType0(Lcom/android/internal/telephony/cdma/sms/UserData;Lcom/android/internal/util/BitwiseInputStream;I)Z
    .locals 9
    .parameter "userData"
    .parameter "inStream"
    .parameter "offset"
    ...
    .line 1472
    const-string v5, "CMAS_MIT"

    const-string v6, " came into decodeE_RecordType0() "
    ...
    iget-object v5, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;
    ...
    iput-byte v6, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->E_Record_Len_0:B

    .line 1476
    const-string v5, "CMAS_TAG"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "E_Record_Len_0: "
    ...
    iget-byte v7, v7, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->E_Record_Len_0:B
    ...
    iput v6, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAS_encoding_type:I
    ...
    iget v7, v7, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAS_encoding_type:I
    ...
    iget v5, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAS_encoding_type:I
    ...
    .line 1507
    .local v0, char_i_Length:I
    :goto_0
    iget-object v5, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    iget-object v6, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    iget-byte v6, v6, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->E_Record_Len_0:B
    ...
    iput v6, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_text_len:I
    ...
    const-string v7, "CMAE_alert_text_len : "
    ...
    iget v7, v7, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_text_len:I
    ...
    iget v6, v6, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_text_len:I
    ...
    iput-object v6, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_payload:[B

    .line 1511
    iget-object v5, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    iget v5, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_text_len:I
    ...
    const-string/jumbo v6, "unsupported CMAS E_Rec_Type_0(before throws)"
    ...
    const-string/jumbo v7, "unsupported CMAS user data encoding ("
    ...
    .line 1488
    .end local v0           #char_i_Length:I
    :pswitch_2
    const/4 v0, 0x7

    .line 1489
    .restart local v0       #char_i_Length:I
    goto :goto_0
    ...
    iget-object v6, v6, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_payload:[B
    ...
    iget v1, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_text_len:I
    ...
    iget-object v5, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_payload:[B
    ...
    iput-object v4, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_payload:[B
    ...
    invoke-static {v6, p2, v7}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeLatin([BII)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v5, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAS_alert_string:Ljava/lang/String;
    ...
    const-string v7, "OCTET-payload string : "
    ...
    iget-object v7, v7, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAS_alert_string:Ljava/lang/String;
    ...
    const-string v7, "Decoding current : "
    ...
    const-string v7, "Decoding Padding : "
    ...
    invoke-static {v6, p2, v7}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decode7bitAscii([BII)Ljava/lang/String;
    ...
    const-string v7, "7bit-payload string : "
    ...
    invoke-static {v6, p2, v7}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decodeUtf16([BII)Ljava/lang/String;
    ...
    invoke-static {v6, p2, v7}, Lcom/android/internal/telephony/cdma/sms/BearerData;->decode7bitGsm([BII)Ljava/lang/String;
...
.method private static decodeE_RecordType1(Lcom/android/internal/telephony/cdma/sms/UserData;Lcom/android/internal/util/BitwiseInputStream;)V
    .locals 7
    .parameter "userData"
    .parameter "inStream"
    .annotation system Ldalvik/annotation/Throws;
    ...
    .line 1573
    const-string v2, "CMAS_TAG"

    const-string v3, "came into decodeE_RecordType1() : BearerData.java"
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;
    ...
    iput-byte v3, v2, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->E_Record_Len_1:B
    ...
    iput v3, v2, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_category:I
    ...
    iget-object v4, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    iget v4, v4, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_category:I
    ...
    iput v3, v2, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_response:I
    ...
    iput v3, v2, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_severity:I
    ...
    iput v3, v2, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_urgency:I
    ...
    iput v3, v2, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_certainty:I
    ...
    const-string v4, "Decoding Padding : "
...
.method private static decodeE_RecordType2(Lcom/android/internal/telephony/cdma/sms/UserData;Lcom/android/internal/util/BitwiseInputStream;)V
    .locals 4
    .parameter "userData"
    .parameter "inStream"
    .annotation system Ldalvik/annotation/Throws;
    ...
    .line 1603
    const-string v0, "CMAS_TAG"

    const-string v1, "came into decodeE_RecordType2() : BearerData.java"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1605
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;
    ...
    iput-byte v1, v0, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->E_Record_Len_2:B
    ...
    iput v1, v0, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_identifier:I

    .line 1609
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    iget-object v1, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    iget v1, v1, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_identifier:I
    ...
    iput v1, v0, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_alert_handling:I

    .line 1613
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/sms/UserData;->smscmas:Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;

    iget-object v0, v0, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->ExpireCmasTime:Lcom/android/internal/telephony/cdma/sms/BearerData$TimeStamp;
    ...
    const-string v2, "Decode Expire Time "
    ...
    iput v1, v0, Lcom/android/internal/telephony/cdma/sms/UserData$smsCmas;->CMAE_language:I
...
.method private static decodeInvalid([BII)Ljava/lang/String;
    ...
    const-string/jumbo v7, "insufficient data (wanted "
...
.method private static decodeSCPData(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseInputStream;)Z
    .locals 10
    .parameter "bData"
    .parameter "inStream"
    .annotation system Ldalvik/annotation/Throws;
    ...
    new-instance v5, Lcom/android/internal/telephony/cdma/sms/SCPData;

    invoke-direct {v5}, Lcom/android/internal/telephony/cdma/sms/SCPData;-><init>()V

    iput-object v5, p0, Lcom/android/internal/telephony/cdma/sms/BearerData;->mSCPData:Lcom/android/internal/telephony/cdma/sms/SCPData;

    .line 2094
    iget-object v5, p0, Lcom/android/internal/telephony/cdma/sms/BearerData;->mSCPData:Lcom/android/internal/telephony/cdma/sms/SCPData;
    ...
    iput v6, v5, Lcom/android/internal/telephony/cdma/sms/SCPData;->encoding:I
    ...
    iput-object v6, v5, Lcom/android/internal/telephony/cdma/sms/SCPData;->programs:Ljava/util/ArrayList;
    ...
    const-string/jumbo v7, "remaining bits = "
    ...
    .line 2104
    new-instance v2, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;

    invoke-direct {v2}, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;-><init>()V

    .line 2106
    .local v2, field:Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;
    invoke-virtual {p1, v9}, Lcom/android/internal/util/BitwiseInputStream;->read(I)I

    move-result v5

    iput v5, v2, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->opCode:I
    ...
    iput v5, v2, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->category:I
    ...
    iput v5, v2, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->language:I
    ...
    iput v5, v2, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->maxMsgs:I
    ...
    iput v5, v2, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->alertOpt:I
    ...
    iput v5, v2, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->numFields:I

    .line 2112
    iget v5, v2, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->numFields:I
    ...
    iput-object v5, v2, Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;->name:[B
    ...
    .line 2116
    invoke-static {v2}, Lcom/android/internal/telephony/cdma/sms/BearerData;->debugPrintField(Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;)V

    .line 2117
    iget-object v5, p0, Lcom/android/internal/telephony/cdma/sms/BearerData;->mSCPData:Lcom/android/internal/telephony/cdma/sms/SCPData;

    iget-object v5, v5, Lcom/android/internal/telephony/cdma/sms/SCPData;->programs:Ljava/util/ArrayList;
    ...
    .line 2121
    .end local v2           #field:Lcom/android/internal/telephony/cdma/sms/SCPData$CategoryField;
    :cond_0
...
.method private static decodeSmsAddress(Lcom/android/internal/telephony/cdma/sms/CdmaSmsAddress;)V
    ...
    :try_start_0
    const-string/jumbo v3, "support_nbpcb"
    ...
    const-string v4, "[SMS.MT.NBPCD] CB and Etc Address DIGIT_MODE_8BIT_CHAR and Address : "
    ...
    .line 1900
    .restart local v1       #tempAddr:Ljava/lang/String;
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    const-string v4, "[SMS.MT.NBPCD] 8bit international without plus, So attached plus = "
    ...
    const-string/jumbo v3, "invalid SMS address ASCII code"
...
.method private static decodeUserData(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseInputStream;)Z
    ...
    const-string/jumbo v6, "sometimes occurs for logging"
...
.method private static decodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;Z)V
    ...
    const-string v7, "cdma_kr_testbed_mms_receive"
...
.method public static encode(Lcom/android/internal/telephony/cdma/sms/BearerData;)[B
    ...
    .line 983
    :cond_b
    iget-object v2, p0, Lcom/android/internal/telephony/cdma/sms/BearerData;->mSCPResult:Lcom/android/internal/telephony/cdma/sms/SCPResult;
    ...
    .line 985
    invoke-static {p0, v1}, Lcom/android/internal/telephony/cdma/sms/BearerData;->encodeSCPTResult(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseOutputStream;)V
...
.method private static encodeMsgCenterTimeStamp(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseOutputStream;)V
    ...
    invoke-static {v0}, Lcom/android/internal/telephony/IccUtils;->cdmaIntTobcdByte(I)B
...
.method private static encodeSCPTResult(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseOutputStream;)V
    .locals 7
    .parameter "bData"
    .parameter "outStream"
    .annotation system Ldalvik/annotation/Throws;
    ...
    .line 1964
    iget-object v4, p0, Lcom/android/internal/telephony/cdma/sms/BearerData;->mSCPResult:Lcom/android/internal/telephony/cdma/sms/SCPResult;

    invoke-virtual {v4}, Lcom/android/internal/telephony/cdma/sms/SCPResult;->getResults()Ljava/util/ArrayList;

    move-result-object v3

    .line 1965
    .local v3, results:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;>;"
    iget-object v4, p0, Lcom/android/internal/telephony/cdma/sms/BearerData;->mSCPResult:Lcom/android/internal/telephony/cdma/sms/SCPResult;

    invoke-virtual {v4}, Lcom/android/internal/telephony/cdma/sms/SCPResult;->getNumResults()I
    ...
    const-string v5, "Trying to encode no results"
    ...
    check-cast v2, Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;

    .line 1974
    .local v2, result:Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;
    invoke-static {v2}, Lcom/android/internal/telephony/cdma/sms/BearerData;->debugPrintResult(Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;)V
    ...
    .line 1978
    iget v4, v2, Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;->category:I

    packed-switch v4, :pswitch_data_0

    .line 2000
    :goto_1
    iget v4, v2, Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;->result:I
    ...
    .line 2005
    .end local v2           #result:Lcom/android/internal/telephony/cdma/sms/SCPResult$ResultField;
    :cond_1
    return-void
...
.method private static getLmsMsgCount([B)I
    .locals 7
    .parameter "text"
    ...
    invoke-static {p0, v4, v6}, Lcom/android/internal/telephony/cdma/sms/BearerData;->lastByteIsMultiChar([BII)Z
