...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;,
...
.field private mDisplayConfiguration:Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    :cond_3
    new-instance v7, Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;

    invoke-direct {v7, p1}, Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/android/internal/widget/LockPatternView;->mDisplayConfiguration:Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;
...
.method private drawInnerCircle(Landroid/graphics/Canvas;IIZ)V
    .locals 12
    .parameter "canvas"
    .parameter "leftX"
    .parameter "topY"
    ...
    iget-boolean v9, p0, Lcom/android/internal/widget/LockPatternView;->mInStealthMode:Z
    ...
    iget v10, p0, Lcom/android/internal/widget/LockPatternView;->mBitmapWidth:I
    ...
    .line 1158
    .local v6, sx:F
    iget v9, p0, Lcom/android/internal/widget/LockPatternView;->mSquareHeight:F

    iget v10, p0, Lcom/android/internal/widget/LockPatternView;->mBitmapHeight:I
    ...
    .line 1160
    .local v7, sy:F
    iget-object v9, p0, Lcom/android/internal/widget/LockPatternView;->mCircleMatrix:Landroid/graphics/Matrix;
    ...
    :cond_1
    iget-boolean v9, p0, Lcom/android/internal/widget/LockPatternView;->mPatternInProgress:Z
    ...
    iget-object v11, p0, Lcom/android/internal/widget/LockPatternView;->mPatternDisplayMode:Lcom/android/internal/widget/LockPatternView$DisplayMode;
...
.method private drawOuterCircle(Landroid/graphics/Canvas;IIZ)V
    .locals 12
    .parameter "canvas"
    .parameter "leftX"
    .parameter "topY"
...
.method private handleActionMove(Landroid/view/MotionEvent;)V
    ...
    iget-object v0, v0, Lcom/android/internal/widget/LockPatternView;->mDisplayConfiguration:Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;

    move-object/from16 v27, v0

    move-object/from16 v0, v27

    iget v0, v0, Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;->mPathWidth:F
...
.method public getSquareHeight()F
    .locals 1
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 880
    .local v26, pattern:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/widget/LockPatternView$Cell;>;"
    ...
    sget-object v33, Lcom/android/internal/widget/LockPatternView$DisplayMode;->Animate:Lcom/android/internal/widget/LockPatternView$DisplayMode;
    ...
    const/high16 v33, 0x442f

    div-float v27, v32, v33

    .line 909
    .local v27, percentageOfNextCircle:F
    ...
    .line 910
    .local v10, currentCell:Lcom/android/internal/widget/LockPatternView$Cell;
    ...
    .line 914
    .local v20, nextCell:Lcom/android/internal/widget/LockPatternView$Cell;
    ...
    mul-float v15, v27, v32

    .line 918
    .local v15, dy:F
    add-float v32, v7, v14
    ...
    .end local v10           #currentCell:Lcom/android/internal/widget/LockPatternView$Cell;
    .end local v14           #dx:F
    .end local v15           #dy:F
    .end local v20           #nextCell:Lcom/android/internal/widget/LockPatternView$Cell;
    .end local v27           #percentageOfNextCircle:F
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/widget/LockPatternView;->invalidate()V
    ...
    .end local v21           #numCircles:I
    .end local v23           #oneCycle:I
    .end local v28           #spotInCycle:I
    :cond_2
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v32 .. v33}, Landroid/graphics/Paint;->setStrokeWidth(F)V
    ...
    sget-object v33, Lcom/android/internal/widget/LockPatternView$DisplayMode;->Wrong:Lcom/android/internal/widget/LockPatternView$DisplayMode;
    ...
    iget v0, v0, Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;->mPathColorWrong:I
    ...
    iget v0, v0, Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;->mPathAlpha:I
    ...
    iget-object v11, v0, Lcom/android/internal/widget/LockPatternView;->mCurrentPath:Landroid/graphics/Path;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/internal/widget/LockPatternView;->drawOuterCircle(Landroid/graphics/Canvas;IIZ)V
    ...
    .end local v29           #squareHeight:F
    .end local v30           #squareWidth:F
    .end local v31           #topY:F
    .restart local v21       #numCircles:I
    .restart local v23       #oneCycle:I
    .restart local v28       #spotInCycle:I
    :cond_3
    const/16 v19, 0x0
    ...
    .end local v23           #oneCycle:I
    .end local v28           #spotInCycle:I
    .restart local v29       #squareHeight:F
    .restart local v30       #squareWidth:F
    :cond_4
    move-object/from16 v0, p0
    ...
    iget v0, v0, Lcom/android/internal/widget/LockPatternView$DisplayConfiguration;->mPathColor:I
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/graphics/Paint;->getFlags()I
    ...
    invoke-virtual/range {v32 .. v33}, Landroid/graphics/Paint;->setFilterBitmap(Z)V
    ...
    iget v0, v6, Lcom/android/internal/widget/LockPatternView$Cell;->row:I

    move/from16 v32, v0

    aget-object v32, v12, v32

    iget v0, v6, Lcom/android/internal/widget/LockPatternView$Cell;->column:I
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/internal/widget/LockPatternView;->drawInnerCircle(Landroid/graphics/Canvas;IIZ)V
