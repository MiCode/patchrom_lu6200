...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 155
    iput-boolean v4, p0, Lcom/android/internal/widget/LockPatternUtils;->isSDcardEncryption:Z
...
.method private updateEncryptionPassword(Ljava/lang/String;)V
    ...
    iput-boolean v11, p0, Lcom/android/internal/widget/LockPatternUtils;->isSDcardEncryption:Z

    .line 611
    const-string v4, "externalStorage"

    .line 612
    .local v4, extPath:Ljava/lang/String;
    const-string/jumbo v5, "internalStorage"

    .line 614
    .local v5, inPath:Ljava/lang/String;
    invoke-virtual {p0, p1}, Lcom/android/internal/widget/LockPatternUtils;->passwordToHashStr(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    .line 615
    .local v9, password_hash:Ljava/lang/String;
    const/16 v11, 0x20
    ...
    .line 618
    .local v1, cut_password_hash:Ljava/lang/String;
    ...
    .line 625
    .local v8, pass_type:Ljava/lang/String;
    :goto_0
    ...
    .line 627
    iget-boolean v11, p0, Lcom/android/internal/widget/LockPatternUtils;->isSDcardEncryption:Z
    ...
    const-string v11, "MOBII"

    const-string v12, "LockPatternUtils:: dpm.getStorageEncryptionStatus()"
    ...
    const-string v12, "Could not find the mount service to update the encryption password"
    ...
    .end local v8           #pass_type:Ljava/lang/String;
    :cond_3
    ...
    .restart local v8       #pass_type:Ljava/lang/String;
    ...
    const-string v12, "LockPatternUtils:: changepw"

    invoke-static {v11, v12}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 642
    invoke-interface {v7, v4, v1, v8}, Landroid/os/storage/IMountService;->externalSDCardChangeEncryptionPassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v12, "LockPatternUtils:: internal changepw"

    invoke-static {v11, v12}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 646
    invoke-interface {v7, v5, v1, v8}, Landroid/os/storage/IMountService;->externalSDCardChangeEncryptionPassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    ...
    const-string v12, "Error changing encryption password"
    ...
    :try_start_1
    invoke-interface {v7, p1}, Landroid/os/storage/IMountService;->changeEncryptionPassword(Ljava/lang/String;)I
...
.method public getPasswordHash()Ljava/lang/String;
    ...
    const-string v8, "getPasswordHash PassHash = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    invoke-static {v4}, Lcom/android/internal/widget/LockPatternUtils;->toHex([B)Ljava/lang/String;
...
.method public passwordToHashStr(Ljava/lang/String;)Ljava/lang/String;
    .locals 9
    .parameter "password"
    ...
    .end local v5           #sha1:[B
    :goto_1
    invoke-static {v2}, Lcom/android/internal/widget/LockPatternUtils;->toHex([B)Ljava/lang/String;
...
.method public saveLockPassword(Ljava/lang/String;IZ)V
    ...
    invoke-interface {v3, v0}, Lcom/lge/cappuccino/IMdm;->computePasswordSimplicity(Ljava/lang/String;)Z

    move-result v26

    .line 723
    .local v26, isSimple:Z
    invoke-static {}, Lcom/lge/cappuccino/Mdm;->getInstance()Lcom/lge/cappuccino/IMdm;
    ...
    invoke-interface {v3, v0}, Lcom/lge/cappuccino/IMdm;->computePasswordComplexity(Ljava/lang/String;)I

    .line 727
    .end local v26           #isSimple:Z
    :cond_0
