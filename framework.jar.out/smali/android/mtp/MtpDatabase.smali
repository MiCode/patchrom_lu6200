...
.method private checkHandleInDB(I)I
    .locals 10
    .parameter "handle"
...
.method private initDeviceProperties(Landroid/content/Context;)V
    ...
    const-string v3, "MtpDatabase >>initDeviceProperties :  databaseFile.exists()"
...
.method private renameFile(ILjava/lang/String;)I
    ...
    .line 782
    .end local v17           #sdDir:Ljava/io/File;
    :cond_1
    if-nez v16, :cond_4
    ...
    .line 777
    .restart local v17       #sdDir:Ljava/io/File;
    if-eqz v17, :cond_2
    ...
    const-string v2, "android.intent.action.MEDIA_SCANNER_MTP_SCAN"
