...
# static fields
.field private static final ACTION_WRITE_BD_ADDR:Ljava/lang/String; = "android.server.BluetoothService.write.bdaddr"

.field private static final BD_ADDR_PROPERTY:Ljava/lang/String; = "persist.service.brcm.bt.mac"

.field private static final BLUETOOTH_ADMIN_PERM:Ljava/lang/String; = "android.permission.BLUETOOTH_ADMIN"

.field static final BLUETOOTH_PERM:Ljava/lang/String; = "android.permission.BLUETOOTH"

.field private static final BRCM_PROPERTY_A2DP_CON:Ljava/lang/String; = "service.brcm.bt.a2dp_con"
...
.field private static final BRCM_PROPERTY_SCMS_T:Ljava/lang/String; = "service.brcm.bt.a2dp_scms_t"
...
.field private static final MESSAGE_WAIT_FOR_BDADDR:I = 0xa
...
.field private static final WRITE_BD_ADDR:Ljava/lang/String; = "write.bdaddr"

.field private static mBDAddrSet:Z = false
...
.field private static mRemoteHSDevices:Ljava/util/HashMap; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private mWaitDisconnect:Z
...
.method static constructor <clinit>()V
    ...
    .line 206
    sput v2, Landroid/server/BluetoothService;->waitCount:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 319
    const-string/jumbo v2, "service.brcm.bt.TRC_HCI"
    ...
    sput-object v2, Landroid/server/BluetoothService;->mChangeNameList:Ljava/util/HashMap;
    ...
    .line 353
    const-string v2, "com.android.settings.powersave.POWERSAVE_ACTIVATION_TO_OTHERS"
    ...
    .line 362
    const-string v2, "broadcom.android.bluetooth.intent.action.CALL_STATE_CHANGED"
    ...
    .line 366
    iput-object v6, p0, Landroid/server/BluetoothService;->mAlarmManager:Landroid/app/AlarmManager;
    ...
    iput-object v2, p0, Landroid/server/BluetoothService;->discoverableTimeOutIntent:Landroid/content/Intent;
    ...
    .line 371
    const-string v2, "com.lge.bluetooth.hid.virtualUnplug"

    invoke-virtual {v1, v2}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 372
    const-string v2, "com.lge.bluetooth.hid.sendData"

    invoke-virtual {v1, v2}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 373
    const-string v2, "com.lge.bluetooth.hid.getReport"

    invoke-virtual {v1, v2}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 374
    const-string v2, "com.lge.bluetooth.hid.setReport"

    invoke-virtual {v1, v2}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 377
    const-string v2, "com.lge.bluetooth.headset.sendConnectionStateChange"
    ...
    .line 384
    :cond_2
    const-string v2, "android.server.BluetoothService.write.bdaddr"
...
.method static synthetic access$1400(Landroid/server/BluetoothService;)Landroid/bluetooth/BluetoothDevice;
    .locals 1
    .parameter "x0"

    .prologue
    .line 119
    iget-object v0, p0, Landroid/server/BluetoothService;->mConnectedDevice:Landroid/bluetooth/BluetoothDevice;

    return-object v0
.end method

.method static synthetic access$1402(Landroid/server/BluetoothService;Landroid/bluetooth/BluetoothDevice;)Landroid/bluetooth/BluetoothDevice;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 119
    iput-object p1, p0, Landroid/server/BluetoothService;->mConnectedDevice:Landroid/bluetooth/BluetoothDevice;
...
.method static synthetic access$1500(Landroid/server/BluetoothService;)Z
    ...
    .prologue
    .line 119
    iget-boolean v0, p0, Landroid/server/BluetoothService;->mWaitDisconnect:Z
...
.method static synthetic access$1502(Landroid/server/BluetoothService;Z)Z
    ...
    .prologue
    .line 119
    iput-boolean p1, p0, Landroid/server/BluetoothService;->mWaitDisconnect:Z

    return p1
.end method

.method static synthetic access$1600(Landroid/server/BluetoothService;)Landroid/bluetooth/BluetoothHeadset;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1700(Landroid/server/BluetoothService;)Landroid/bluetooth/BluetoothAdapter;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$300()Z
    ...
    .prologue
    .line 119
    sget-boolean v0, Landroid/server/BluetoothService;->mBDAddrSet:Z
...
.method static synthetic access$302(Z)Z
    ...
    .prologue
    .line 119
    sput-boolean p0, Landroid/server/BluetoothService;->mBDAddrSet:Z
...
.method static synthetic access$600()I
    ...
    .prologue
    .line 119
    sget v0, Landroid/server/BluetoothService;->waitCount:I
...
.method static synthetic access$608()I
    ...
    sput v1, Landroid/server/BluetoothService;->waitCount:I
...
.method private native enterBluetoothDUTModeBleNative()I
.end method

.method private native enterBluetoothDUTModeExNative(I)I
.end method
...
.method private native getServiceTrustNative(Ljava/lang/String;Ljava/lang/String;)Z
.end method
...
.method private native isBluetoothDUTModeNative()I
.end method
...
.method private declared-synchronized updateSdpRecords()V
    ...
    invoke-static {v2}, Landroid/bluetooth/BluetoothServiceConfig;->isServiceSupported(Ljava/lang/String;)Z
...
.method public CreateChangedNameList()Z
    ...
    const-string v11, "[BTUI] CreateChangedNameList"
...
.method public declared-synchronized enable(Z)Z
    ...
    const-string v5, "enable...  saveSetting = "
    ...
    .line 694
    const-string/jumbo v3, "service.brcm.bt.a2dp_scms_t"
    ...
    .line 695
    const-string/jumbo v3, "service.brcm.bt.a2dp_con"
    ...
    const-string v3, "Oops: enable BT in Airplane mode..."
    ...
    const-string v3, "[BTUI] ### Block Bluetooth ON : wrong state = "
    ...
    invoke-direct {p0, v2}, Landroid/server/BluetoothService;->BtUiLog(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Landroid/bluetooth/BluetoothAdapter;->isDUTMode()I
    ...
    invoke-virtual {v1}, Landroid/bluetooth/BluetoothAdapter;->exitBluetoothDUTMode()I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public declared-synchronized enterBluetoothDUTMode()I
    ...
    .line 3602
    const-string/jumbo v0, "persist.service.btui.ble"

    .line 3603
    .local v0, PROPERTY_BTUI_SIG:Ljava/lang/String;
    const-string v1, "0"
    ...
    .line 3604
    invoke-direct {p0}, Landroid/server/BluetoothService;->enterBluetoothDUTModeBleNative()I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 3599
    .end local v0           #PROPERTY_BTUI_SIG:Ljava/lang/String;
    :catchall_0
    move-exception v1
...
.method public declared-synchronized enterBluetoothDUTModeEx(I)I
    .locals 3
    .parameter "index"
    ...
    .line 3625
    invoke-direct {p0, p1}, Landroid/server/BluetoothService;->enterBluetoothDUTModeExNative(I)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getChangedNameList(Ljava/lang/String;)Z
    ...
    const-string v2, "[BTUI] getChangeNameList return false"
    ...
    const-string v1, "[BTUI] getChangedNameList return true"
...
.method public declared-synchronized getDeviceBlockedState(Ljava/lang/String;)Z
    ...
    const-string v6, "getDeviceBlockedState("
    ...
    .line 3569
    .local v2, prop_val:[Ljava/lang/String;
    const/4 v1, 0x0
    ...
    .end local v1           #i:I
    .end local v2           #prop_val:[Ljava/lang/String;
    :catchall_0
    move-exception v3
    ...
    const-string/jumbo v5, "setDeviceBlockedState, Device not paired."
...
.method public declared-synchronized getHSDeviceStatus(Landroid/bluetooth/BluetoothDevice;)Z
    .locals 6
    .parameter "device"
    ...
    const-string v5, "[BTUI] getHSDeviceStatus : device("
    ...
    sget-object v5, Landroid/server/BluetoothService;->mRemoteHSDevices:Ljava/util/HashMap;
    ...
    .line 3671
    sget-object v3, Landroid/server/BluetoothService;->mRemoteHSDevices:Ljava/util/HashMap;
    ...
    .line 3672
    .local v0, compdev:Landroid/bluetooth/BluetoothDevice;
    ...
    .line 3681
    .end local v0           #compdev:Landroid/bluetooth/BluetoothDevice;
    :cond_1
    const-string v3, "BluetoothService"
    ...
    const-string v5, "[BTUI] getHSDeviceStatus : isHSDevice = "
...
.method public declared-synchronized getServiceTrust(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 4
    .parameter "address"
    .parameter "service"
    ...
    invoke-direct {p0, v0, p2}, Landroid/server/BluetoothService;->getServiceTrustNative(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized isAmpBusy()Z
    .locals 1
    ...
    :try_start_0
    iget-boolean v0, p0, Landroid/server/BluetoothService;->mIsAmpBusy:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized isDUTMode()I
    .locals 3
    ...
    .line 3634
    invoke-direct {p0}, Landroid/server/BluetoothService;->isBluetoothDUTModeNative()I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized setHSDeviceStatus(Landroid/bluetooth/BluetoothDevice;Z)V
    .locals 3
    .parameter "device"
    .parameter "status"
    ...
    :try_start_0
    sget-object v0, Landroid/server/BluetoothService;->mRemoteHSDevices:Ljava/util/HashMap;
    ...
    const-string v1, "[BTUI] setHSDeviceStatus : HashMap clear because of BT OFF"
    ...
    const-string v2, "[BTUI] setHSDeviceStatus : device("
    ...
    sget-object v2, Landroid/server/BluetoothService;->mRemoteHSDevices:Ljava/util/HashMap;
...
.method public setIsAmpBusy(Z)V
    ...
    .prologue
    .line 3649
    const-string/jumbo v1, "service.btui.ampstate"
    ...
    .line 3650
    iput-boolean p1, p0, Landroid/server/BluetoothService;->mIsAmpBusy:Z
...
.method public declared-synchronized setScanMode(II)Z
    ...
    iget-object v6, p0, Landroid/server/BluetoothService;->discoverableTimeOutIntent:Landroid/content/Intent;
    ...
    iput-object v4, p0, Landroid/server/BluetoothService;->mPendingIntent:Landroid/app/PendingIntent;
    ...
    invoke-interface {v4, v5}, Lcom/lge/cappuccino/IMdm;->checkBluetoothAudioOnly(Ljava/lang/String;)Z
    ...
    const-string/jumbo v5, "startDiscovery : MDM Block"
