...
.method private handleSinkStateChange(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    .line 611
    const-string/jumbo v2, "service.brcm.bt.a2dp_scms_t"
    ...
    const-string v4, "GetProp SCMS-T = "
    ...
    invoke-virtual {p0, p1, v2}, Landroid/server/BluetoothA2dpService;->configureSinkCPType(Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    const-string v4, "SCMST NOT support. CP_Type setting : Free 0 for device:"
    ...
    invoke-virtual {v2, p1, v5, p3, p2}, Landroid/server/BluetoothService;->sendConnectionStateChange(Landroid/bluetooth/BluetoothDevice;III)V
    ...
    iput-object v2, p0, Landroid/server/BluetoothA2dpService;->mPlayingA2dpDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    const-string v4, "SCMST SUPPORT. CP_Type setting: Never 3 for device:"
...
.method private declared-synchronized onSinkPropertyChanged(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string v7, "[BTUI] [A2DP] onSinkPropertyChanged : state ("
    ...
    const-string v7, ") [0:discnt / 1:cnting / 2:cnted / 3:discnting / 10:playing]"
