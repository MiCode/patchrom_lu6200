...
# instance fields
.field private final DEVICE_TYPE_BLE:B

.field private final DEVICE_TYPE_BREDR:B

.field private final DEVICE_TYPE_DUMO:B
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    iput-byte v0, p0, Landroid/bluetooth/BluetoothDevice;->DEVICE_TYPE_BREDR:B

    .line 870
    const/4 v0, 0x2

    iput-byte v0, p0, Landroid/bluetooth/BluetoothDevice;->DEVICE_TYPE_BLE:B

    .line 871
    const/4 v0, 0x3

    iput-byte v0, p0, Landroid/bluetooth/BluetoothDevice;->DEVICE_TYPE_DUMO:B
...
.method public RestoreChangedlist()Z
    ...
    const-string v10, "[BTUI] RemoteException : "
...
.method public getChangedNameList(Ljava/lang/String;)Z
    ...
    const-string v3, "[BTUI] getChangedNameList : address = "
...
.method public getServiceTrust(Ljava/lang/String;)Z
    .locals 4
    .parameter "service"
    ...
    const-string v3, "[BTUI] getServiceTrust = "
    ...
    invoke-interface {v1, v2, p1}, Landroid/bluetooth/IBluetooth;->getServiceTrust(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setChangedNameList()Z
    ...
    const-string v7, "[BTUI] setChangedNameList"
