...
.method constructor <init>(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiVZWConfiguration;)V
    ...
    iput-object p2, p0, Landroid/net/wifi/WifiStateMachine$4;->val$config:Landroid/net/wifi/WifiVZWConfiguration;
...
.method public run()V
    ...
    const-string/jumbo v4, "startVZWSoftApWithConfig "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Landroid/net/wifi/WifiStateMachine$4;->val$config:Landroid/net/wifi/WifiVZWConfiguration;

    iget-object v4, v4, Landroid/net/wifi/WifiVZWConfiguration;->SSID:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/net/wifi/WifiStateMachine$4;->val$config:Landroid/net/wifi/WifiVZWConfiguration;
    ...
    invoke-interface {v2, v3, v4, v5}, Landroid/os/INetworkManagementService;->startVZWAccessPoint(Landroid/net/wifi/WifiVZWConfiguration;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-interface {v2, v3}, Landroid/os/INetworkManagementService;->stopVZWAccessPoint(Ljava/lang/String;)V
