...
.method public getWifiNetworksAvailableNoti()Z
    .locals 2
    ...
    invoke-interface {v1}, Landroid/net/wifi/IWifiManager;->getWifiNetworksAvailableNoti()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setWifiEnabledTemp(Z)Z
    .locals 2
    .parameter "enabled"
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setWifiEnabledTemp(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setWifiEnabledbySDM(Z)Z
    .locals 2
    .parameter "enabled"
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setWifiEnabledbySDM(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setWifiNetworksAvailableNoti(Z)Z
    .locals 2
    .parameter "bSet"
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setWifiNetworksAvailableNoti(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setWifiVZWApConfiguration(Landroid/net/wifi/WifiVZWConfiguration;)Z
    .locals 2
    .parameter "wifiConfig"
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setWifiVZWApConfiguration(Landroid/net/wifi/WifiVZWConfiguration;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setWifiVZWApEnabled(Landroid/net/wifi/WifiVZWConfiguration;Z)Z
    .locals 2
    .parameter "wifiConfig"
    .parameter "enabled"
    ...
    invoke-interface {v1, p1, p2}, Landroid/net/wifi/IWifiManager;->setWifiVZWApEnabled(Landroid/net/wifi/WifiVZWConfiguration;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
