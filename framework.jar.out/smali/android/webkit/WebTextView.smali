...
# instance fields
.field private final mAllowToSupportRTLForNormarlField:Z
...
.field private mEditRtlMap:Ljava/util/HashMap;
...
.field private mIsNewBuildingRTL:Z

.field private mIsRtlEditMode:Z
...
.method constructor <init>(Landroid/content/Context;Landroid/webkit/WebView;I)V
    ...
    .line 151
    iput-boolean v6, p0, Landroid/webkit/WebTextView;->mAllowToSupportRTLForNormarlField:Z
    ...
    iput-object v3, p0, Landroid/webkit/WebTextView;->mEditRtlMap:Ljava/util/HashMap;
...
.method private isRtlNode(IZ)Z
    ...
    .line 1361
    iget-object v0, p0, Landroid/webkit/WebTextView;->mEditRtlMap:Ljava/util/HashMap;
    ...
    iget v1, p0, Landroid/webkit/WebTextView;->mNodePointer:I
...
.method private lineUpScroll()V
    ...
    const-string/jumbo v5, "onTouchEvent x="
...
.method private setAdaptGravity(I)V
    .locals 3
    .parameter "gravity"

    .prologue
    .line 1385
    iget-boolean v1, p0, Landroid/webkit/WebTextView;->mIsNewBuildingRTL:Z
    ...
    .line 1408
    :goto_1
    invoke-virtual {p0, p1}, Landroid/webkit/WebTextView;->setGravity(I)V

    .line 1409
    iput p1, p0, Landroid/webkit/WebTextView;->mPrevGravity:I
...
.method private setWritingDirection(Landroid/webkit/WebTextView$WritingDirection;)V
    .locals 3
    .parameter "direction"
    ...
    invoke-virtual {p1}, Landroid/webkit/WebTextView$WritingDirection;->ordinal()I
...
.method public initRtlData()V
    ...
    .line 1379
    iput-boolean v0, p0, Landroid/webkit/WebTextView;->mIsRtlEditMode:Z

    .line 1380
    iput v0, p0, Landroid/webkit/WebTextView;->mPrevGravity:I
...
.method protected onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    .line 635
    .local v15, postChange:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 640
    invoke-virtual/range {p0 .. p0}, Landroid/webkit/WebTextView;->getGravity()I
    ...
    invoke-direct {v0, v2}, Landroid/webkit/WebTextView;->isArabicChar(C)Z
    ...
    .line 648
    sget-object v2, Landroid/webkit/WebTextView$WritingDirection;->RIGHT_TO_LEFT:Landroid/webkit/WebTextView$WritingDirection;

    move-object/from16 v0, p0

    invoke-direct {v0, v2}, Landroid/webkit/WebTextView;->setWritingDirection(Landroid/webkit/WebTextView$WritingDirection;)V

    .line 656
    :goto_0
    move-object/from16 v0, p0

    iget v2, v0, Landroid/webkit/WebTextView;->mPrevGravity:I
    ...
    invoke-direct {v0, v9}, Landroid/webkit/WebTextView;->setAdaptGravity(I)V
    ...
    .line 654
    sget-object v2, Landroid/webkit/WebTextView$WritingDirection;->LEFT_TO_RIGHT:Landroid/webkit/WebTextView$WritingDirection;
    ...
    iget-boolean v2, v0, Landroid/webkit/WebTextView;->mIsRtlEditMode:Z
    ...
    .line 671
    .local v13, needToUpdateGravity:Z
    const/4 v9, 0x3
    ...
    iget-boolean v2, v0, Landroid/webkit/WebTextView;->mSingle:Z
    ...
    .line 701
    .end local v9           #gravity:I
    .end local v13           #needToUpdateGravity:Z
    :cond_7
    move-object/from16 v0, p0
    ...
    iput-object v15, v0, Landroid/webkit/WebTextView;->mPreChange:Ljava/lang/String;

    goto/16 :goto_1

    .line 672
    .end local v14           #oldEnd:I
    .restart local v9       #gravity:I
    .restart local v13       #needToUpdateGravity:Z
    :cond_9
    const/16 v2, 0x30
    ...
    .line 737
    .local v16, replaceButOne:Ljava/lang/String;
    add-int v2, p2, p3
    ...
    .line 739
    .local v17, replacedString:Ljava/lang/String;
    ...
    .line 746
    .end local v16           #replaceButOne:Ljava/lang/String;
    .end local v17           #replacedString:Ljava/lang/String;
    :cond_11
    move-object/from16 v0, p0
    ...
    .line 754
    .local v11, kmap:Landroid/view/KeyCharacterMap;
    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/webkit/WebTextView;->mCharacter:[C

    invoke-virtual {v11, v2}, Landroid/view/KeyCharacterMap;->getEvents([C)[Landroid/view/KeyEvent;

    move-result-object v8

    .line 757
    .end local v11           #kmap:Landroid/view/KeyCharacterMap;
    :cond_12
    move-object/from16 v0, p0
    ...
    .line 806
    .restart local v18       #useKeyEvents:Z
    :cond_1c
    add-int v2, p2, p4
...
.method public setBuildingRTL(Z)V
    .locals 0
    .parameter "value"

    .prologue
    .line 1416
    iput-boolean p1, p0, Landroid/webkit/WebTextView;->mIsNewBuildingRTL:Z
...
.method public setGravityForRtl(Z)V
    ...
    invoke-direct {p0, v1, p1}, Landroid/webkit/WebTextView;->isRtlNode(IZ)Z
    ...
    .line 1298
    :cond_0
    iput-boolean p1, p0, Landroid/webkit/WebTextView;->mIsRtlEditMode:Z

    .line 1299
    invoke-virtual {p0}, Landroid/webkit/WebTextView;->getGravity()I
    ...
    .line 1302
    iget-object v1, p0, Landroid/webkit/WebTextView;->mPreChange:Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Landroid/webkit/WebTextView;->isArabicChar(C)Z
    ...
    invoke-direct {p0, v1}, Landroid/webkit/WebTextView;->setWritingDirection(Landroid/webkit/WebTextView$WritingDirection;)V
    ...
    .line 1308
    invoke-direct {p0, v0}, Landroid/webkit/WebTextView;->setAdaptGravity(I)V
    ...
    .line 1323
    :cond_4
    iget v1, p0, Landroid/webkit/WebTextView;->mPrevGravity:I
...
.method public setInputType(I)V
    ...
    iput-boolean v1, p0, Landroid/webkit/WebTextView;->mFromSetInputType:Z

    .line 1044
    iget-object v0, p0, Landroid/webkit/WebTextView;->mPreChange:Ljava/lang/String;
    ...
    iput-object v1, p0, Landroid/webkit/WebTextView;->mPreChange:Ljava/lang/String;

    .line 1046
    invoke-super {p0, p1}, Landroid/widget/AutoCompleteTextView;->setInputType(I)V

    .line 1047
    iput-object v0, p0, Landroid/webkit/WebTextView;->mPreChange:Ljava/lang/String;
