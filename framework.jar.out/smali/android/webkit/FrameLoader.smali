...
.method private handleCache()Z
    ...
    const-string v5, "FrameLoader: checking cache: "
...
.method public executeLoad()Z
    ...
    const-string v4, "FrameLoader.executeLoad: url protocol not supported:"
...
.method handleHTTPLoad()Z
    ...
    const-string v6, "FrameLoader: http "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Landroid/webkit/FrameLoader;->mMethod:Ljava/lang/String;

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, " load for: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Landroid/webkit/FrameLoader;->mListener:Landroid/webkit/LoadListener;

    invoke-virtual {v6}, Landroid/webkit/LoadListener;->url()Ljava/lang/String;
