...
.method private putReal3DProfile(Landroid/content/Context;Landroid/content/Intent;)V
    .locals 5
    .parameter "ctx"
    .parameter "intent"
    ...
    invoke-interface {v3, v2}, Landroid/app/IActivityManager;->getReal3DProfile(Ljava/lang/String;)Landroid/opengl/EGLReal3DProfile;
    ...
    iget-boolean v4, v1, Landroid/opengl/EGLReal3DProfile;->mIsEnable:Z
    ...
    const-string v4, ".REAL3D_PROFILE_QUALITY"
    ...
    iget v4, v1, Landroid/opengl/EGLReal3DProfile;->mQuality:I
    ...
    const-string v4, ".REAL3D_PROFILE_TYPE"
    ...
    iget v4, v1, Landroid/opengl/EGLReal3DProfile;->mType:I
    ...
    const-string v4, ".REAL3D_PROFILE_REFDEPTH"
    ...
    iget v4, v1, Landroid/opengl/EGLReal3DProfile;->mRefDepth:F

    invoke-virtual {p2, v3, v4}, Landroid/content/Intent;->putExtra(Ljava/lang/String;F)Landroid/content/Intent;
    ...
    const-string v4, ".REAL3D_PROFILE_DEPTH_SCALE"
    ...
    iget v4, v1, Landroid/opengl/EGLReal3DProfile;->mDepthScale:F
    ...
    const-string v4, ".REAL3D_PROFILE_IS_CHAIN"
...
.method public execStartActivity(Landroid/content/Context;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/Activity;Landroid/content/Intent;I)Landroid/app/Instrumentation$ActivityResult;
    ...
    invoke-direct {v0, v1, v2}, Landroid/app/Instrumentation;->putReal3DProfile(Landroid/content/Context;Landroid/content/Intent;)V
