...
.method private persistVolume(Landroid/media/AudioService$VolumeStreamState;ZZ)V
    ...
    const-string v2, "[persistVolume]... bootSound volume = "
...
.method private playSoundEffect(II)V
    ...
    invoke-virtual {v0, v1, v3}, Landroid/media/AudioService;->checkPlayConditions(IZ)Z
...
.method private setSystemRingerMode(Z)V
    .locals 8
    .parameter "persist"
    ...
    const-string/jumbo v2, "setSystemRingerMode as persist "
    ...
    invoke-static {v0, v3}, Landroid/media/AudioSystem;->setRingerMode(II)I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$4500(I)I
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$4600(Landroid/media/AudioService;)Landroid/media/AudioSystem$ErrorCallback;
    ...
    invoke-static/range {v16 .. v16}, Landroid/media/AudioService$VolumeStreamState;->access$4900(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-static {v1, v2, v3}, Landroid/media/AudioService;->access$5000(Landroid/media/AudioService;IZ)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$5100(Landroid/media/AudioService;)V
    ...
    invoke-static {v2, v1, v3}, Landroid/media/AudioService;->access$5200(Landroid/media/AudioService;Landroid/media/AudioService$RemoteControlStackEntry;I)V
    ...
    invoke-direct {v0, v1}, Landroid/media/AudioService$AudioHandler;->setSystemRingerMode(Z)V
    ...
    const-string/jumbo v3, "handleMessage()..MSG_SET_HEADSET_VOLUME!!! msg.arg1 = "
    ...
    invoke-static {v1, v2, v3, v4}, Landroid/media/AudioService;->access$3300(Landroid/media/AudioService;III)I
    ...
    #calls: Landroid/media/AudioService;->setStreamVolumeIndex(II)V
    invoke-static {v1, v2, v13}, Landroid/media/AudioService;->access$3100(Landroid/media/AudioService;II)V
    ...
    invoke-virtual {v1, v2, v13, v3}, Landroid/media/AudioService;->setStreamVolume(III)V

    goto/16 :goto_0

    .line 2534
    .end local v13           #newVolume:I
    :pswitch_11
    const-string v1, "AudioService"
    ...
    const-string/jumbo v3, "handleMessage()..MSG_CHECK_HEADSET_VOLUME!!! headsetState = "
    ...
    #calls: Landroid/media/AudioService;->changeHeadsetVolume(II)V
    invoke-static {v1, v2, v3}, Landroid/media/AudioService;->access$5400(Landroid/media/AudioService;II)V
